...
REGION_LIST: dict[str, LMRegionInfo] = {
    ...
    "Anteroom": LMRegionInfo(2, 2, 39, 42, ["Wardrobe Key", "Anteroom Key", "Parlor Key"],
        ["Wardrobe Key", "Anteroom Key"], [43, 38], True, -1.503195, 550.000000, -3087.626950),
    "The Well": LMRegionInfo(2, 0, 69, 72, []),
    "Wardrobe": LMRegionInfo(2, 2, 38, 40, ["Wardrobe Key", "Anteroom Key", "Parlor Key", "Heart Key"],
        ["Wardrobe Key", "Wardrobe Balcony Key"], [43, 41], True, -1789.859250, 550.000000, -3303.123780),
    ...
    "Ballroom": LMRegionInfo(2, 1, 10, 9,  ["Ballroom Key", "Storage Room Key"], ["Ballroom Key", "Storage Room Key"],
        [15, 16], True, 2854.236820, 0.000000, -1565.909060),
    ...
    "1F Bathroom": LMRegionInfo(2, 1, 20, 21, ["1F Bathroom Key", "Heart Key"], ["1F Bathroom Key"], [23],
        True, -2160.237550, 0.000000, -4671.114750),
    ...
    "Projection Room": LMRegionInfo(2, 1, 13, 13, ["Projection Room Key", "Billiards Room Key"],
        ["Projection Room Key", "Billiards Room Key"], [18], True, 281.914215, 0.000000, -3137.967530),
    "Kitchen": LMRegionInfo(2, 1, 8, 7, []),
    "Boneyard": LMRegionInfo(2, 1, 11, 11, []),
    "Graveyard": LMRegionInfo(2, 1, 16, 15, []),
    ...
    "2F Washroom": LMRegionInfo(2, 2, 42, 45, []),
    ...
    "Sealed Room": LMRegionInfo(2, 2, 36, 37, []),
    ...
    "Safari Room": LMRegionInfo(2, 3, 52, 55, ["Safari Room Key", "East Attic Hallway Key", "Balcony Key"],
        ["Safari Room Key", "East Attic Hallway Key"], [55, 56], True, 3317.313480, 1100.000000, 225.000000),
    "East Attic Hallway": LMRegionInfo(2, 3, 51, 54, []),
    "West Attic Hallway": LMRegionInfo(2, 3, 49, 57, []),
    "Artist's Studio": LMRegionInfo(2, 3, 57, 60, []),
    "Balcony": LMRegionInfo(2, 3, 59, 62, []),
    "Armory": LMRegionInfo(2, 3, 48, 51, ["Armory Key", "Balcony Key", "Telephone Room Key"],
        ["Armory Key", "Ceramics Studio Key"], [50, 51], True, -2541.662600, 1100.000000, -40.361595),
    ...
    "Telephone Room": LMRegionInfo(2, 3, 50, 53, ["Telephone Room Key", "Clockwork Key"],
        ["Telephone Room Key", "Clockwork Key"], [52, 53], True, -9.812825, 1100.000000, 118.738243),
