...
FIRSTPER_EQUIV = ["First Person Trap", "Controller Drift Trap", "Disable B Trap", "Disable Z Trap", "Camera Trap", "Flip Horizontal Trap", "Flip Vertical Trap", "Inverted Mouse Trap", "Isometric Trap", "Reverse Trap", "Zoom In Trap", "Zoom Out Trap", "Zoom Trap", "Screen Flip Trap", "Deisometric Trap"]
