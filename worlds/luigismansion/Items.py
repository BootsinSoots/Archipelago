...
PORTRAIT_ITEMS: dict[str, LMItemData] = {
    "Shivers's Candelabra": LMItemData("Portrait Spawner", 187, IC.progression, update_ram_addr=),
    "Neville's Book": LMItemData("Portrait Spawner", 188, IC.progression, update_ram_addr=),
    "Lydia's Brush": LMItemData("Portrait Spawner", 189, IC.progression, update_ram_addr=),
    "Chauncey's Pacifier": LMItemData("Portrait Spawner", 190, IC.progression, update_ram_addr=),
    "Whirlindas' Dance Steps": LMItemData("Portrait Spawner", 191, IC.progression, update_ram_addr=),
    "Melody's Music Sheets": LMItemData("Portrait Spawner", 192, IC.progression, update_ram_addr=),
    "Mr. Luggs's Utensils": LMItemData("Portrait Spawner", 193, IC.progression, update_ram_addr=),
    "Spooky's Collar": LMItemData("Portrait Spawner", 194, IC.progression, update_ram_addr=),
    "Bogmire's Shadow": LMItemData("Portrait Spawner", 195, IC.progression, update_ram_addr=),
    "Biff's Weights": LMItemData("Portrait Spawner", 196, IC.progression, update_ram_addr=),
    "Petunia's Shower Cap": LMItemData("Portrait Spawner", 197, IC.progression, update_ram_addr=),
    "Nana's Yarn Balls": LMItemData("Portrait Spawner", 198, IC.progression, update_ram_addr=),
    "Bankshot's Pool Cue": LMItemData("Portrait Spawner", 199, IC.progression, update_ram_addr=),
    "The Twins' Mobile": LMItemData("Portrait Spawner", 200, IC.progression, update_ram_addr=),
    "Clairvoya's Crystal Ball": LMItemData("Portrait Spawner", 201, IC.progression, update_ram_addr=),
    "Boolossus's Bahamas Ticket": LMItemData("Portrait Spawner", 202, IC.progression, update_ram_addr=),
    "Grimmly's Mirror": LMItemData("Portrait Spawner", 203, IC.progression, update_ram_addr=),
    "Toy Soldiers' Wind-up Keys": LMItemData("Portrait Spawner", 204, IC.progression, update_ram_addr=),
    "Sue Pea's Bed": LMItemData("Portrait Spawner", 205, IC.progression, update_ram_addr=),
    "Sir Weston's Backpack": LMItemData("Portrait Spawner", 206, IC.progression, update_ram_addr=),
    "Jarvis's Vase Collection": LMItemData("Portrait Spawner", 207, IC.progression, update_ram_addr=),
    "Van Gore's Paintbrush": LMItemData("Portrait Spawner", 208, IC.progression, update_ram_addr=),
}
