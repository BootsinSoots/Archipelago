...
from rule_builder.rules import Rule, Has, OptionFilter, True_, CanReachLocation

from .Rules import HasVac, CanFstFire, CanFstWater, CanFstIce, VacnIce, HasMarioItems, HasKey
from .Helper_Functions import LMRamData
from.LuigiOptions import Enemizer
...
class LMLocationData(NamedTuple):
    ...
    access: Optional[Rule] = None  # items required to access location, many special cases
    floor: int = 0
...
BASE_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Huge Flower (Boneyard)":   LMLocationData("Boneyard", 70, "Chest", 8, CanFstWater & Has("Progressive Flower", count=3),
    ...
    "Wardrobe Clear Chest": LMLocationData("Wardrobe", 0, "Chest", 22, Has("Blackout") & HasVac,
...
FREESTANDING_KEY_TABLE: dict[str, LMLocationData] = {
    ...
    "Fortune Teller Candles": LMLocationData("Fortune-Teller's Room", 6, "Freestanding", 4, CanFstFire,
        remote_only=True, update_ram_addr=[LMRamData(0x803D33A6, bit_position=6, in_game_room_id=3)]),
    "The Well Key": LMLocationData("The Well", 21, "Freestanding", 0, HasVac, remote_only=True,
        update_ram_addr=[LMRamData(0x803CDFDA, bit_position=1, ram_byte_size=2)]),
    "Wardrobe Shelf Key": LMLocationData("Wardrobe", 50, "Freestanding", 5, HasVac, remote_only=True,
        update_ram_addr=[LMRamData(0x803D33A6, bit_position=6, in_game_room_id=41)]),
    "1F Bathroom Shelf Key": LMLocationData("1F Bathroom", 54, "Freestanding", 3, HasVac, remote_only=True,
...
CLEAR_GHOST_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Butler Clear Chest": LMLocationData("Butler's Room", 8, "Chest", 0, Has("Shivers Spawn") & CanFstFire,
        update_ram_addr=[LMRamData(0x803CDF50, bit_position=2, in_game_room_id=0, ram_byte_size=2)]),
    "Guest Room Clear Chest": LMLocationData("Guest Room", 46, "Chest", 17, CanFstWater,
        update_ram_addr = [LMRamData(0x803CDF88, bit_position=2, in_game_room_id=29, ram_byte_size=2)]),
    "Parlor Clear Chest": LMLocationData("Parlor", 47, "Chest", 20, HasKey(34)|HasKey(38),
        update_ram_addr=[LMRamData(0x803CDF96, bit_position=2, in_game_room_id=36, ram_byte_size=2)]),
    "Cold Storage Clear Chest": LMLocationData("Cold Storage", 48, "Chest", 33, CanFstFire,
        update_ram_addr=[LMRamData(0x803CDFCA, bit_position=2, in_game_room_id=64, ram_byte_size=2)]),
    "Breaker Room Clear Chest": LMLocationData("Breaker Room", 49, "Chest", 36, Has("Blackout"),
    ...
    "Balcony Clear Chest": LMLocationData("Balcony", 27, "Chest", 31, CanFstIce,
        update_ram_addr=[LMRamData(0x803CDFC6, bit_position=2, in_game_room_id=62, ram_byte_size=2)]),
    "Ceramics Studio Clear Chest": LMLocationData("Ceramics Studio", 28, "Chest", 30, CanFstIce,
        update_ram_addr=[LMRamData(0x803CDFBE, bit_position=2, in_game_room_id=58, ram_byte_size=2)]),
    "2F Bathroom Clear Chest": LMLocationData("2F Bathroom", 22, "Chest", 24, CanFstIce,
    ...
    "Dining Room Clear Chest": LMLocationData("Dining Room", 17, "Chest", 6, CanFstFire,
        update_ram_addr=[LMRamData(0x803CDF62, bit_position=2, in_game_room_id=8, ram_byte_size=2)]),
    "Fortune Teller Clear Chest": LMLocationData("Fortune-Teller's Room", 5, "Chest", 2, HasMarioItems,
    ...
    "Pipe Room Clear Chest": LMLocationData("Pipe Room", 64, "Chest", 35, CanFstIce,
...
ENEMIZER_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Defeat Boolossus": LMLocationData("Balcony", 922, "Portrait", 56, CanFstIce,
...
PLANT_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Wardrobe Balcony Plant R (near Door)": LMLocationData("Wardrobe Balcony", 65, "Plant", 473,
        CanFstWater, 2, update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Wardrobe Balcony Plant L (next to Toad)": LMLocationData("Wardrobe Balcony", 66, "Plant", 474,
        CanFstWater, 2, update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Wardrobe Balcony Plant C": LMLocationData("Wardrobe Balcony", 67, "Plant", 475, CanFstWater, 2,
    ...
    "Wardrobe Balcony Plant L (in Corner)": LMLocationData("Wardrobe Balcony", 68, "Plant", 476,
        CanFstWater, 2, update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Master Bedroom Plant": LMLocationData("Master Bedroom", 69, "Plant", 542, CanFstWater, 2,
        update_ram_addr=[LMRamData(in_game_room_id=34)]),
    "Courtyard SW Plant": LMLocationData("Courtyard", 71, "Plant", 142, CanFstWater, 1,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard NW Plant": LMLocationData("Courtyard", 72, "Plant", 143, CanFstWater, 1,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard NE Plant": LMLocationData("Courtyard", 73, "Plant", 144, CanFstWater, 1,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard SE Plant": LMLocationData("Courtyard", 74, "Plant", 145, CanFstWater, 1,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Balcony Plant NW Not Near Bench": LMLocationData("Balcony", 75, "Plant", 604, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant E Railing": LMLocationData("Balcony", 76, "Plant", 605, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Near Bench": LMLocationData("Balcony", 77, "Plant", 606, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Corner Near Bench": LMLocationData("Balcony", 78, "Plant", 607, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant SW Corner": LMLocationData("Balcony", 81, "Plant", 610, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Corner": LMLocationData("Balcony", 82, "Plant", 611, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony West Double Plant": LMLocationData("Balcony", 83, "Plant", 612, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Center R": LMLocationData("Balcony", 84, "Plant", 613, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Directly in NE Corner": LMLocationData("Balcony", 872, "Plant", 608, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant SE Corner": LMLocationData("Balcony", 80, "Plant", 609, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Second from Right Plant near NW Bench": LMLocationData("Balcony", 873, "Plant", 615,
        CanFstWater, 3, update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Furthest Right Plant near NW Bench": LMLocationData("Balcony", 874, "Plant", 614,
        CanFstWater, 3, update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Second from Right in NE Corner": LMLocationData("Balcony", 875, "Plant", 616, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Center L": LMLocationData("Balcony", 88, "Plant", 712, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Third from Right in NE Corner": LMLocationData("Balcony", 876, "Plant", 713, CanFstWater, 3,
        update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Sitting Room Plant": LMLocationData("Sitting Room", 91, "Plant", 409, CanFstWater, 2,
        update_ram_addr=[LMRamData(in_game_room_id=28)]),
    "Guest Room Plant": LMLocationData("Guest Room", 92, "Plant", 417, CanFstWater, 2,
        update_ram_addr=[LMRamData(in_game_room_id=29)]),
}

CEILING_LOCATION_TABLE: dict[str, LMLocationData] ={
    "Heart Door Lamp": LMLocationData("Foyer", 94, "Furniture", 270, floor=1,
                                      update_ram_addr=[LMRamData(in_game_room_id=2)]),
    "Foyer Chandelier": LMLocationData("Foyer", 95, "Furniture", 101, floor=1,
                                       update_ram_addr=[LMRamData(in_game_room_id=2)]),
    "Parlor Chandelier": LMLocationData("Parlor", 104, "Furniture", 342, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Anteroom R Chandelier": LMLocationData("Anteroom", 120, "Furniture", 485, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=42)]),
    "Anteroom L Chandelier": LMLocationData("Anteroom", 121, "Furniture", 467, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=42)]),
    "Wardrobe Chandelier": LMLocationData("Wardrobe", 122, "Furniture", 454, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Balcony Brazier": LMLocationData("Wardrobe Balcony", 130, "Furniture", 472, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Study Chandelier": LMLocationData("Study", 140, "Furniture", 352, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Master Bedroom Ceiling Fan": LMLocationData("Master Bedroom", 161, "Furniture", 373, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=34)]),
    "Nursery Ceiling Lamp": LMLocationData("Nursery", 177, "Furniture", 374, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Twins' Room Star Light": LMLocationData("Twins' Room", 183, "Furniture", 423, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "1F Washroom Light": LMLocationData("1F Washroom", 205, "Furniture", 91, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=16)]),
    "Ballroom West Chandelier": LMLocationData("Ballroom", 207, "Furniture", 173, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=9)]),
    "Ballroom East Chandelier": LMLocationData("Ballroom", 208, "Furniture", 174, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=9)]),
    "Storage Room Ceiling Light": LMLocationData("Storage Room", 216, "Furniture", 163, floor=1,
                                                 update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Mirror Room West Chandelier": LMLocationData("Mirror Room", 238, "Furniture", 158, floor=1,
                                                  update_ram_addr=[LMRamData(in_game_room_id=4)]),
    "Mirror Room East Chandelier": LMLocationData("Mirror Room", 239, "Furniture", 159, floor=1,
                                                  update_ram_addr=[LMRamData(in_game_room_id=4)]),
    "Laundry Room Ceiling Light": LMLocationData("Laundry Room", 246, "Furniture", 195, floor=1,
                                                 update_ram_addr=[LMRamData(in_game_room_id=5)]),
    "Butler's Room Ceiling Light": LMLocationData("Butler's Room", 257, "Furniture", 228, floor=1,
                                                  update_ram_addr=[LMRamData(in_game_room_id=0)]),
    "Hidden Room Chandelier": LMLocationData("Hidden Room", 267, "Furniture", 240, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Kitchen L Ceiling Light": LMLocationData("Kitchen", 315, "Furniture", 84, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Kitchen R Ceiling Light": LMLocationData("Kitchen", 316, "Furniture", 85, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Rec Room L Ceiling Light": LMLocationData("Rec Room", 347, "Furniture", 111, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room R Ceiling Light": LMLocationData("Rec Room", 348, "Furniture", 110, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "2F Stairwell Ceiling Light": LMLocationData("2F Stairwell", 349, "Furniture", 310, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=18)]),
    "Attic Stairwell Ceiling Light": LMLocationData("2F Rear Hallway", 369, "Furniture", 547, floor=3,
                                                 update_ram_addr=[LMRamData(in_game_room_id=33)]),
    "Tea Room Chandelier": LMLocationData("Tea Room", 365, "Furniture", 399, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "2F Washroom Light": LMLocationData("2F Washroom", 383, "Furniture", 442, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=45)]),
    "Nana's Room Chandelier": LMLocationData("Nana's Room", 395, "Furniture", 378, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=49)]),
    "Astral Hall Chandelier": LMLocationData("Astral Hall", 403, "Furniture", 446, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=43)]),
    "Billiards Room Ceiling Fan": LMLocationData("Billiards Room", 421, "Furniture", 156, floor=1,
                                                 update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Projection Room L Ceiling Light": LMLocationData("Projection Room", 427, "Furniture", 199, floor=1,
                                                      update_ram_addr=[LMRamData(in_game_room_id=13)]),
    "Projection Room R Ceiling Light": LMLocationData("Projection Room", 428, "Furniture", 200, floor=1,
                                                      update_ram_addr=[LMRamData(in_game_room_id=13)]),
    "Safari Room L Ceiling Light": LMLocationData("Safari Room", 436, "Furniture", 631, floor=3,
                                                  update_ram_addr=[LMRamData(in_game_room_id=55)]),
    "Safari Room R Ceiling Light": LMLocationData("Safari Room", 437, "Furniture", 632, floor=3,
                                                  update_ram_addr=[LMRamData(in_game_room_id=55)]),
    ...
    "Telephone Room L Ceiling Light": LMLocationData("Telephone Room", 479, "Furniture", 671, floor=3,
                                                     update_ram_addr=[LMRamData(in_game_room_id=53)]),
    "Telephone Room R Ceiling Light": LMLocationData("Telephone Room", 480, "Furniture", 672, floor=3,
                                                     update_ram_addr=[LMRamData(in_game_room_id=53)]),
    "Clockwork Room R Ceiling Light": LMLocationData("Clockwork Room", 486, "Furniture", 596, floor=3,
                                                     update_ram_addr=[LMRamData(in_game_room_id=59)]),
    "Clockwork Room L Ceiling Light": LMLocationData("Clockwork Room", 487, "Furniture", 595, floor=3,
                                                     update_ram_addr=[LMRamData(in_game_room_id=59)]),
    "Armory Ceiling Light": LMLocationData("Armory", 526, "Furniture", 636, floor=3,
                                           update_ram_addr=[LMRamData(in_game_room_id=51)]),
    "Ceramics Studio Ceiling Light": LMLocationData("Ceramics Studio", 533, "Furniture", 657, floor=3,
                                                    update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Sealed Room Chandelier": LMLocationData("Sealed Room", 557, "Furniture", 463, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Artist's Studio Light": LMLocationData("Artist's Studio", 597, "Furniture", 684, floor=3,
                                            update_ram_addr=[LMRamData(in_game_room_id=60)]),
    "Basement Stairwell Hanging Light": LMLocationData("Basement Stairwell", 596, "Furniture", 62, floor=1,
                                                       update_ram_addr=[LMRamData(in_game_room_id=67)]),
    "Conservatory Ceiling Light": LMLocationData("Conservatory", 283, "Furniture", 137, floor=1,
...
DECOR_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Foyer Mirror": LMLocationData("Foyer", 96, "Furniture", 208, floor=1,
                                   update_ram_addr=[LMRamData(in_game_room_id=2)], require_poltergust=False),
    "Upper Foyer R Vase": LMLocationData("Foyer", 97, "Furniture", 336, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=31)]),
    "Upper Foyer L Vase": LMLocationData("Foyer", 98, "Furniture", 335, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=31)]),
    "Parlor Green Lamp": LMLocationData("Parlor", 107, "Furniture", 490, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Wardrobe Mirror": LMLocationData("Wardrobe", 126, "Furniture", 480, floor=2,
                                      update_ram_addr=[LMRamData(in_game_room_id=41)], require_poltergust=False),
    "Study Lamp": LMLocationData("Study", 138, "Furniture", 349, floor=2,
                                 update_ram_addr=[LMRamData(in_game_room_id=35)], require_poltergust=False),
    "Study Bottled Ship": LMLocationData("Study", 142, "Furniture", 353, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Book (on Desk closer to Door)": LMLocationData("Study", 145, "Furniture", 503, floor=2,
                                                          update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Book (on Desk closer to Bookshelves)": LMLocationData("Study", 146, "Furniture", 504, floor=2,
                                                                 update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Lydia's Vanity (Master Bedroom)": LMLocationData("Master Bedroom", 159, "Furniture", 375, floor=2,
                                                      update_ram_addr=[LMRamData(in_game_room_id=34)], require_poltergust=False,
                                                      hide_boo=False),
    "Master Bedroom Lamp": LMLocationData("Master Bedroom", 165, "Furniture", 493, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=34)]),
    "Nursery Vase": LMLocationData("Nursery", 166, "Furniture", 488, floor=2,
                                   update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Chauncey's Crib (Nursery)": LMLocationData("Nursery", 167, "Furniture", 372, floor=2, remote_only=True,
                                                update_ram_addr=[LMRamData(in_game_room_id=26)], require_poltergust=False),
    "Nursery Toy Blocks R (closer to Door)": LMLocationData("Nursery", 173, "Furniture", 498, floor=2,
                                                            update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Nursery Toy Blocks R (closer to 4th Wall)": LMLocationData("Nursery", 178, "Furniture", 499, floor=2,
                                                                update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Twins' Room Tennis Rackets": LMLocationData("Twins' Room", 180, "Furniture", 562, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "Twins' Room Toy Train": LMLocationData("Twins' Room", 184, "Furniture", 430, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "Twins' Room Toy Car": LMLocationData("Twins' Room", 185, "Furniture", 431, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "Twins' Room Toy Truck": LMLocationData("Twins' Room", 191, "Furniture", 432, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "1F Hallway Front Vase L": LMLocationData("1F Hallway", 705, "Furniture", 93, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=6)]),
    "1F Hallway Front Vase C": LMLocationData("1F Hallway", 706, "Furniture", 94, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=6)]),
    "1F Hallway Front Vase R": LMLocationData("1F Hallway", 193, "Furniture", 95, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=6)]),
    "1F Hallway Rear Vase L": LMLocationData("1F Hallway", 194, "Furniture", 102, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=17)]),
    "1F Hallway Rear Vase C": LMLocationData("1F Hallway", 195, "Furniture", 103, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=17)]),
    "1F Hallway Rear Vase R": LMLocationData("1F Hallway", 196, "Furniture", 283, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=17)]),
    "1F Bathroom Sink": LMLocationData("1F Bathroom", 197, "Furniture", 216, floor=1,
                                       update_ram_addr=[LMRamData(in_game_room_id=21)], require_poltergust=False),
    "1F Bathroom Bathtub": LMLocationData("1F Bathroom", 198, "Furniture", 166, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=21)]),
    "1F Washroom Toilet Paper": LMLocationData("1F Washroom", 200, "Furniture", 269, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=16)]),
    "1F Washroom Sink": LMLocationData("1F Washroom", 707, "Furniture", 89, floor=1,
                                       update_ram_addr=[LMRamData(in_game_room_id=16)], require_poltergust=False),
    "1F Washroom Radiator": LMLocationData("1F Washroom", 203, "Furniture", 90, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=16)], require_poltergust=False),
    "Fortune Teller's Room West Pillar": LMLocationData("Fortune-Teller's Room", 232, "Furniture", 297, floor=1,
                                                        update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Fortune Teller's Room East Pillar": LMLocationData("Fortune-Teller's Room", 233, "Furniture", 298, floor=1,
                                                        update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Mirror Room Brazier": LMLocationData("Mirror Room", 235, "Furniture", 302, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=4)], require_poltergust=False),
    "Laundry Room Broom": LMLocationData("Laundry Room", 241, "Furniture", 192, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=5)]),
    "Laundry Room Dustpan": LMLocationData("Laundry Room", 243, "Furniture", 194, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=5)]),
    "Butler's Room Toilet Paper (near Hidden Room)": LMLocationData("Butler's Room", 255, "Furniture", 219, floor=1,
                                                                    update_ram_addr=[LMRamData(in_game_room_id=0)]),
    "Butler's Room Toilet Paper (near Mop n Bucket)": LMLocationData("Butler's Room", 256, "Furniture", 220, floor=1,
                                                                     update_ram_addr=[LMRamData(in_game_room_id=0)]),
    "Hidden Room R Trophy": LMLocationData("Hidden Room", 263, "Furniture", 236, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Hidden Room L Trophy": LMLocationData("Hidden Room", 264, "Furniture", 237, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Conservatory Xylophone Music Stand": LMLocationData("Conservatory", 279, "Furniture", 126, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Harp Music Stand": LMLocationData("Conservatory", 280, "Furniture", 127, floor=1,
                                                    update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Xylophone": LMLocationData("Conservatory", 284, "Furniture", 132, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Cello": LMLocationData("Conservatory", 285, "Furniture", 131, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Left Bongo": LMLocationData("Conservatory", 286, "Furniture", 123, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Right Bongo": LMLocationData("Conservatory", 287, "Furniture", 122, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Center Bongo": LMLocationData("Conservatory", 288, "Furniture", 121, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Harp": LMLocationData("Conservatory", 289, "Furniture", 133, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Saxophone": LMLocationData("Conservatory", 290, "Furniture", 305, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Dining Room L Brazier": LMLocationData("Dining Room", 296, "Furniture", 281, floor=1,
                                            update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Dining Room R Brazier": LMLocationData("Dining Room", 297, "Furniture", 282, floor=1,
                                            update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Dining Room Table Mess L (furthest Left)": LMLocationData("Dining Room", 300, "Furniture", 211, floor=1,
                                                               update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Dining Room Table Mess L (near Luggs)": LMLocationData("Dining Room", 301, "Furniture", 212, floor=1,
                                                            update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Dining Room Table Mess R (near Candles)": LMLocationData("Dining Room", 302, "Furniture", 213, floor=1,
                                                              update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Dining Room Table Mess R": LMLocationData("Dining Room", 303, "Furniture", 214, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Dining Room Table Mess L (underneath Table)": LMLocationData("Dining Room", 304, "Furniture", 215, floor=1,
                                                                  update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Kitchen Oven": LMLocationData("Kitchen", 307, "Furniture", 80, CanFstFire, 1,
        update_ram_addr=[LMRamData(in_game_room_id=7)], hide_boo=False),
    "Kitchen Dishwasher": LMLocationData("Kitchen", 314, "Furniture", 82, floor=1, remote_only=True,
                                         update_ram_addr=[LMRamData(in_game_room_id=7)], require_poltergust=False),
    "Spooky's Dog Bowl (Boneyard)": LMLocationData("Boneyard", 317, "Furniture", 97, floor=1,
                                                   update_ram_addr=[LMRamData(in_game_room_id=11)]),
    "Boneyard Faucet": LMLocationData("Boneyard", 318, "Furniture", 98, floor=1,
                                      update_ram_addr=[LMRamData(in_game_room_id=11)], require_poltergust=False),
    "Boneyard Sign": LMLocationData("Boneyard", 319, "Furniture", 280, floor=1,
                                    update_ram_addr=[LMRamData(in_game_room_id=11)], require_poltergust=False),
    "Bogmire's Tombstone (Graveyard)": LMLocationData("Graveyard", 321, "Furniture", 181, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard L Brazier": LMLocationData("Graveyard", 322, "Furniture", 182, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard R Brazier": LMLocationData("Graveyard", 323, "Furniture", 183, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard Tombstone (near Tree stump)": LMLocationData("Graveyard", 324, "Furniture", 175, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard Tombstone (back row, right side)": LMLocationData("Graveyard", 325, "Furniture", 176, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard Tombstone (center, right side)": LMLocationData("Graveyard", 327, "Furniture", 178, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard Tombstone (far right near drain pipe)": LMLocationData("Graveyard", 328, "Furniture", 179, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Graveyard Tombstone (left side, near bogmire)": LMLocationData("Graveyard", 329, "Furniture", 180, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Courtyard Outhouse": LMLocationData("Courtyard", 330, "Furniture", 271, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=24)], require_poltergust=False),
    "Courtyard Male Statue": LMLocationData("Courtyard", 331, "Furniture", 274, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=24)], require_poltergust=False),
    "Courtyard Female Statue": LMLocationData("Courtyard", 332, "Furniture", 273, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=24)], require_poltergust=False),
    "Courtyard R Lamppost": LMLocationData("Courtyard", 333, "Furniture", 275, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=24)], require_poltergust=False),
    "Courtyard L Lamppost": LMLocationData("Courtyard", 334, "Furniture", 276, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=24)], require_poltergust=False),
    "Well Lantern": LMLocationData("The Well", 335, "Furniture", 42,
        update_ram_addr=[LMRamData(in_game_room_id=72)]),
    "Rec Room Weight Station": LMLocationData("Rec Room", 336, "Furniture", 109, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=23)], require_poltergust=False),
    "Rec Room Rear Bicycle": LMLocationData("Rec Room", 339, "Furniture", 108, floor=1,
                                            update_ram_addr=[LMRamData(in_game_room_id=23)], require_poltergust=False),
    "Tea Room L Tea Set": LMLocationData("Tea Room", 351, "Furniture", 400, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "Tea Room R Tea Set": LMLocationData("Tea Room", 352, "Furniture", 401, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "Tea Room L Stored China": LMLocationData("Tea Room", 361, "Furniture", 397, floor=2,
                                              update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "Tea Room R Stored China": LMLocationData("Tea Room", 362, "Furniture", 398, floor=2,
                                              update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "2F Rear Hallway Vase L (near Guest Room)": LMLocationData("2F Rear Hallway", 370, "Furniture", 518, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=32)]),
    "2F Rear Hallway Vase R (near Guest Room)": LMLocationData("2F Rear Hallway", 371, "Furniture", 519, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=32)]),
    "2F Rear Hallway Vase Furthest Left": LMLocationData("2F Rear Hallway", 372, "Furniture", 521, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=46)]),
    "2F Rear Hallway Vase Second from Left": LMLocationData("2F Rear Hallway", 373, "Furniture", 522, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=46)]),
    "2F Rear Hallway Vase near Astral Hall": LMLocationData("2F Rear Hallway", 374, "Furniture", 523, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=46)]),
    "2F Rear Hallway Vase near 2F Stairwell": LMLocationData("2F Rear Hallway", 375, "Furniture", 524, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=46)]),
    "2F Washroom Water Tank (above Toilet)": LMLocationData("2F Washroom", 376, "Furniture", 445, floor=2,
        update_ram_addr=[LMRamData(in_game_room_id=45)], remote_only=True),
    "Tea Room Tea Box": LMLocationData("Tea Room", 366, "Furniture", 481, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "2F Washroom Radiator": LMLocationData("2F Washroom", 380, "Furniture", 441, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=45)], require_poltergust=False),
    "2F Washroom Toilet Paper": LMLocationData("2F Washroom", 382, "Furniture", 439, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=45)]),
    "2F Washroom Sink": LMLocationData("2F Washroom", 384, "Furniture", 440, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=45)], require_poltergust=False),
    "Petunia's Bathtub (2F Bathroom)": LMLocationData("2F Bathroom", 385, "Furniture", 436, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=48)]),
    "2F Bathroom Sink": LMLocationData("2F Bathroom", 387, "Furniture", 500, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=48)], require_poltergust=False),
    "Nana's Room Spinning Wheel": LMLocationData("Nana's Room", 388, "Furniture", 385, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Nana's Room Books": LMLocationData("Nana's Room", 396, "Furniture", 416, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=49)]),
    "Nana's Room Shelf Photos": LMLocationData("Nana's Room", 397, "Furniture", 381, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=49)]),
    "Nana's Room Shelf Clock": LMLocationData("Nana's Room", 398, "Furniture", 379, floor=2,
                                              update_ram_addr=[LMRamData(in_game_room_id=49)]),
    "Nana's Room Shelf Pots": LMLocationData("Nana's Room", 399, "Furniture", 380, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=49)]),
    "Nana's Yarn Balls (Nana's Room)": LMLocationData("Nana's Room", 401, "Furniture", 382, floor=2,
                                                      update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Billiards Room Table Drinks (near Chest)": LMLocationData("Billiards Room", 422, "Furniture", 292, floor=1,
                                                               update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Billiards Room Table Drinks (near Dart Board)": LMLocationData("Billiards Room", 423, "Furniture", 291, floor=1,
                                                                    update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Projection Room Projector": LMLocationData("Projection Room", 425, "Furniture", 206, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=13)]),
    "Projection Room L Speaker": LMLocationData("Projection Room", 429, "Furniture", 201, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=13)], require_poltergust=False),
    "Projection Room R Speaker": LMLocationData("Projection Room", 430, "Furniture", 202, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=13)], require_poltergust=False),
    "Safari Room Leopard Chest Box": LMLocationData("Safari Room", 433, "Furniture", 633, floor=3,
                                                    update_ram_addr=[LMRamData(in_game_room_id=55)], require_poltergust=False),
    "Balcony West Statue": LMLocationData("Balcony", 443, "Furniture", 621, floor=3,
                                          update_ram_addr=[LMRamData(in_game_room_id=62)], require_poltergust=False),
    "Balcony East Statue": LMLocationData("Balcony", 444, "Furniture", 620, floor=3,
                                          update_ram_addr=[LMRamData(in_game_room_id=62)], require_poltergust=False),
    "Clockwork Room R Puppet": LMLocationData("Clockwork Room", 488, "Furniture", 603, floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room L Puppet": LMLocationData("Clockwork Room", 489, "Furniture", 602, floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Roof Pillar (bottom row, furthest left)": LMLocationData("Roof", 505, "Furniture", 717, floor=4,
                                                              update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (top row, furthest left)": LMLocationData("Roof", 506, "Furniture", 718, floor=4,
                                                           update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (bottom row, second from left)": LMLocationData("Roof", 507, "Furniture", 719, floor=4,
                                                                 update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (top row, second from left)": LMLocationData("Roof", 508, "Furniture", 720, floor=4,
                                                              update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (bottom row, third from left)": LMLocationData("Roof", 509, "Furniture", 721, floor=4,
                                                                update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (top row, third from left)": LMLocationData("Roof", 510, "Furniture", 722, floor=4,
                                                             update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (bottom row, third from right)": LMLocationData("Roof", 511, "Furniture", 723, floor=4,
                                                                 update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (top row, third from right)": LMLocationData("Roof", 512, "Furniture", 724, floor=4,
                                                              update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (bottom row, second from right)": LMLocationData("Roof", 513, "Furniture", 725, floor=4,
                                                                  update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (top row, second from right)": LMLocationData("Roof", 514, "Furniture", 726, floor=4,
                                                               update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (top row, furthest right)": LMLocationData("Roof", 515, "Furniture", 727, floor=4,
                                                            update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Roof Pillar (bottom row, furthest right)": LMLocationData("Roof", 516, "Furniture", 728, floor=4,
                                                               update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Armory Armor Suit R (top)": LMLocationData("Armory", 517, "Furniture", 642, floor=3,
                                                update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit (middle, right)": LMLocationData("Armory", 518, "Furniture", 643, floor=3,
                                                        update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit (middle, left)": LMLocationData("Armory", 519, "Furniture", 644, floor=3,
                                                       update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit (middle, second from left)": LMLocationData("Armory", 520, "Furniture", 645, floor=3,
                                                                   update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit L (right side)": LMLocationData("Armory", 521, "Furniture", 646, floor=3,
                                                       update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Ceramics Studio Ice Vase": LMLocationData("Ceramics Studio", 534, "Furniture", 658, floor=3,
                                               update_ram_addr=[LMRamData(in_game_room_id=58)], require_poltergust=False),
    "Ceramics Studio Vase (bottom right)": LMLocationData("Ceramics Studio", 544, "Furniture", 660, floor=3,
                                                          update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (bottom middle)": LMLocationData("Ceramics Studio", 545, "Furniture", 661, floor=3,
                                                           update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (bottom left)": LMLocationData("Ceramics Studio", 546, "Furniture", 662, floor=3,
                                                         update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (bottom more left)": LMLocationData("Ceramics Studio", 547, "Furniture", 663, floor=3,
                                                              update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (top more left)": LMLocationData("Ceramics Studio", 548, "Furniture", 666, floor=3,
                                                           update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (top left)": LMLocationData("Ceramics Studio", 549, "Furniture", 667, floor=3,
                                                      update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (top middle)": LMLocationData("Ceramics Studio", 550, "Furniture", 668, floor=3,
                                                        update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Vase (top right)": LMLocationData("Ceramics Studio", 551, "Furniture", 669, floor=3,
                                                       update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Sealed Room L Plate": LMLocationData("Sealed Room", 561, "Furniture", 462, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room R Plate": LMLocationData("Sealed Room", 562, "Furniture", 461, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room L Trophy": LMLocationData("Sealed Room", 567, "Furniture", 456, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room R Rear Trophy": LMLocationData("Sealed Room", 568, "Furniture", 457, floor=2,
                                                update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room R Middle Trophy": LMLocationData("Sealed Room", 569, "Furniture", 458, floor=2,
                                                  update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room R Front Trophy": LMLocationData("Sealed Room", 570, "Furniture", 455, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Guest Room Vanity": LMLocationData("Guest Room", 579, "Furniture", 421, CanFstWater, 2,
    ...
    "Artist's Studio Art Supply Shelves": LMLocationData("Artist's Studio", 599, "Furniture", 685, floor=3,
                                                         update_ram_addr=[LMRamData(in_game_room_id=60)]),
    "Artist's Studio Biff Bust": LMLocationData("Artist's Studio", 600, "Furniture", 686, floor=3,
                                                update_ram_addr=[LMRamData(in_game_room_id=60)]),
    "Artist's Studio Brick Pile": LMLocationData("Artist's Studio", 601, "Furniture", 687, floor=3,
                                                 update_ram_addr=[LMRamData(in_game_room_id=60)]),
    "Artist's Studio Art Piece Shelves": LMLocationData("Artist's Studio", 602, "Furniture", 688, floor=3,
                                                        update_ram_addr=[LMRamData(in_game_room_id=60)]),
    ...
    "Secret Altar Brazier (near front, away from 4th Wall)": LMLocationData("Secret Altar", 611, "Furniture", 29,
        update_ram_addr=[LMRamData(in_game_room_id=73)], require_poltergust=False),
    "Armory Armor Suit 6": LMLocationData("Armory", 522, "Furniture", 647, floor=3 ,remote_only=True,
                                                    update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit 7": LMLocationData("Armory", 523, "Furniture", 648, floor=3, remote_only=True,
                                                    update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit 8": LMLocationData("Armory", 524, "Furniture", 649, floor=3, remote_only=True,
                                                    update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    "Armory Armor Suit 9": LMLocationData("Armory", 525, "Furniture", 650, floor=3, remote_only=True,
                                                    update_ram_addr=[LMRamData(in_game_room_id=51)], require_poltergust=False),
    ...
    "Artist's Studio Gold Ghost Easel": LMLocationData("Artist's Studio", 603, "Furniture", 691, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Artist's Studio Pink Ghost Easel": LMLocationData("Artist's Studio", 604, "Furniture", 692, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Artist's Studio Blue Ghost Easel": LMLocationData("Artist's Studio", 605, "Furniture", 693, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Artist's Studio Red Ghost Easel": LMLocationData("Artist's Studio", 606, "Furniture", 694, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Artist's Studio Shy Guy Ghost Easel": LMLocationData("Artist's Studio", 607, "Furniture", 695, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Artist's Studio Banana Boys Squad Easel": LMLocationData("Artist's Studio", 608, "Furniture", 696, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Artist's Studio Purple Ghost Easel": LMLocationData("Artist's Studio", 609, "Furniture", 697, floor=3, remote_only=True,
        update_ram_addr=[LMRamData(in_game_room_id=60)], hide_boo=False),
    "Safari Room C Deer Head": LMLocationData("Safari Room", 439, "Furniture", 630, floor=3, remote_only=True,
                                                update_ram_addr=[LMRamData(in_game_room_id=55)]),
    "Kitchen Refrigerator": LMLocationData("Kitchen", 308, "Furniture", 78, floor=1, remote_only=True,
                                                update_ram_addr=[LMRamData(in_game_room_id=7)], require_poltergust=False),
    "Graveyard Tombstone 3": LMLocationData("Graveyard", 326, "Furniture", 177, floor=1, remote_only=True,
                                                    update_ram_addr=[LMRamData(in_game_room_id=15)], require_poltergust=False),
    "Rec Room Front Bicycle": LMLocationData("Rec Room", 338, "Furniture", 107, floor=1, remote_only=True,
                                             update_ram_addr=[LMRamData(in_game_room_id=23)], require_poltergust=False),
    "2F Washroom Toilet": LMLocationData("2F Washroom", 378, "Furniture", 443, floor=2, remote_only=True,
                                                    update_ram_addr=[LMRamData(in_game_room_id=45)], require_poltergust=False),
}

CANDLES_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Mirror Room West Candlestick": LMLocationData("Mirror Room", 236, "Furniture", 306, floor=1,
                                                   update_ram_addr=[LMRamData(in_game_room_id=4)], require_poltergust=False),
    "Mirror Room East Candlestick": LMLocationData("Mirror Room", 237, "Furniture", 307, floor=1,
                                                   update_ram_addr=[LMRamData(in_game_room_id=4)], require_poltergust=False),
    "Fortune Teller's Room West Candlestick": LMLocationData("Fortune-Teller's Room", 228, "Furniture", 119, floor=1,
                                                             update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Fortune Teller's Room East Candlestick": LMLocationData("Fortune-Teller's Room", 229, "Furniture", 293, floor=1,
                                                             update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Parlor Table Candle": LMLocationData("Parlor", 108, "Furniture", 556, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Parlor West Three Candles": LMLocationData("Parlor", 109, "Furniture", 511, floor=2,
                                                update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Parlor East Three Candles": LMLocationData("Parlor", 110, "Furniture", 512, floor=2,
                                                update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Foyer R Candlestick": LMLocationData("Foyer", 714, "Furniture", 99, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=2)], require_poltergust=False),
    "Foyer L Candlestick": LMLocationData("Foyer", 99, "Furniture", 100, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=2)]),
    "Hidden Room R Candlestick": LMLocationData("Hidden Room", 265, "Furniture", 238, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Hidden Room L Candlestick": LMLocationData("Hidden Room", 266, "Furniture", 239, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Dining Room R Candles and Plates": LMLocationData("Dining Room", 305, "Furniture", 287, floor=1,
                                                       update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Dining Room L Candles": LMLocationData("Dining Room", 306, "Furniture", 288, floor=1,
                                            update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Tea Room L Candlestick": LMLocationData("Tea Room", 367, "Furniture", 546, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "Astral Hall North Candlabra": LMLocationData("Astral Hall", 404, "Furniture", 447, floor=2,
                                                  update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Astral Hall East Candlabra": LMLocationData("Astral Hall", 405, "Furniture", 448, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Astral Hall West Candlabra": LMLocationData("Astral Hall", 406, "Furniture", 449, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Astral Hall SW Candlabra": LMLocationData("Astral Hall", 407, "Furniture", 450, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Astral Hall SE Candlabra": LMLocationData("Astral Hall", 408, "Furniture", 451, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Cellar Back Candle": LMLocationData("Cellar", 473, "Furniture", 10,
                                         update_ram_addr=[LMRamData(in_game_room_id=66)]),
    "Cellar Left Candle": LMLocationData("Cellar", 474, "Furniture", 11,
                                         update_ram_addr=[LMRamData(in_game_room_id=66)]),
    "Roof Campfire": LMLocationData("Roof", 850, "Furniture", 729, floor=4,
                                    update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Sealed Room L Mantle Candles": LMLocationData("Sealed Room", 563, "Furniture", 459, floor=2,
                                                   update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room R Mantle Candles": LMLocationData("Sealed Room", 564, "Furniture", 460, floor=2,
                                                   update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room L Table Candles": LMLocationData("Sealed Room", 565, "Furniture", 465, floor=2,
                                                  update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room R Table Candles": LMLocationData("Sealed Room", 566, "Furniture", 466, floor=2,
                                                  update_ram_addr=[LMRamData(in_game_room_id=37)]),
...
HANGABLES_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Parlor Painting L (closer to 4th Wall)": LMLocationData("Parlor", 112, "Furniture", 344, floor=2,
                                                             update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Parlor Painting L (near China Cabinet)": LMLocationData("Parlor", 113, "Furniture", 343, floor=2,
                                                             update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Parlor Center Painting": LMLocationData("Parlor", 114, "Furniture", 347, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Parlor Painting R (near Anteroom Door)": LMLocationData("Parlor", 115, "Furniture", 346, floor=2,
                                                             update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Parlor Painting R (closer to 4th Wall)": LMLocationData("Parlor", 116, "Furniture", 345, floor=2,
                                                             update_ram_addr=[LMRamData(in_game_room_id=36)]),
    "Wardrobe Purple Dress": LMLocationData("Wardrobe", 131, "Furniture", 452, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Red Dress": LMLocationData("Wardrobe", 132, "Furniture", 505, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Blue Shirt": LMLocationData("Wardrobe", 133, "Furniture", 506, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Brown Suit": LMLocationData("Wardrobe", 134, "Furniture", 507, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Black Shirt": LMLocationData("Wardrobe", 135, "Furniture", 508, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Green Jacket": LMLocationData("Wardrobe", 136, "Furniture", 509, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "Wardrobe Yellow Dress": LMLocationData("Wardrobe", 137, "Furniture", 510, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=41)]),
    "2F Washroom Mirror": LMLocationData("2F Washroom", 377, "Furniture", 544, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=45)]),
    "1F Washroom Mirror": LMLocationData("1F Washroom", 201, "Furniture", 234, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=16)]),
    "Study Painting L (closer to 4th Wall)": LMLocationData("Study", 147, "Furniture", 553, floor=2,
                                                            update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Painting L (near Bookshelves)": LMLocationData("Study", 148, "Furniture", 552, floor=2,
                                                          update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Painting R (near Bookshelves)": LMLocationData("Study", 149, "Furniture", 555, floor=2,
                                                          update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Painting R (closer to 4th Wall)": LMLocationData("Study", 150, "Furniture", 554, floor=2,
                                                            update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Master Bedroom Painting L": LMLocationData("Master Bedroom", 162, "Furniture", 361, floor=2,
                                                update_ram_addr=[LMRamData(in_game_room_id=34)]),
    "Master Bedroom Painting R (near Window)": LMLocationData("Master Bedroom", 163, "Furniture", 363, floor=2,
                                                              update_ram_addr=[LMRamData(in_game_room_id=34)]),
    "Master Bedroom Painting R (closer to 4th Wall)": LMLocationData("Master Bedroom", 164, "Furniture", 362, floor=2,
                                                                     update_ram_addr=[LMRamData(in_game_room_id=34)]),
    "Nursery Wall Picture": LMLocationData("Nursery", 174, "Furniture", 368, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Nursery Picture R (closer to Door)": LMLocationData("Nursery", 175, "Furniture", 369, floor=2,
                                                         update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Nursery Picture R (closer to 4th Wall)": LMLocationData("Nursery", 176, "Furniture", 370, floor=2,
                                                             update_ram_addr=[LMRamData(in_game_room_id=26)]),
    "Twins' Room Dartboard": LMLocationData("Twins' Room", 181, "Furniture", 424, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "Twins' Room Picture L (farthest from Globe)": LMLocationData("Twins' Room", 187, "Furniture", 551, floor=2,
                                                                  update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "Twins' Room Picture L (closest to Globe)": LMLocationData("Twins' Room", 188, "Furniture", 549, floor=2,
                                                               update_ram_addr=[LMRamData(in_game_room_id=27)]),
    "1F Hallway Painting": LMLocationData("1F Hallway", 704, "Furniture", 104, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=17)]),
    "1F Washroom Picture": LMLocationData("1F Washroom", 202, "Furniture", 235, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=16)]),
    "Ballroom Portrait": LMLocationData("Ballroom", 210, "Furniture", 172, floor=1 ,
                                        update_ram_addr=[LMRamData(in_game_room_id=9)]),
    "Mirror Room Picture": LMLocationData("Mirror Room", 240, "Furniture", 210, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=4)]),
    "Hidden Room Painting Middle C": LMLocationData("Hidden Room", 268, "Furniture", 248, floor=1,
                                                    update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Hidden Room Painting R": LMLocationData("Hidden Room", 269, "Furniture", 249, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Hidden Room Painting L": LMLocationData("Hidden Room", 270, "Furniture", 250, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Hidden Room Painting Middle L": LMLocationData("Hidden Room", 271, "Furniture", 299, floor=1,
                                                    update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Hidden Room Painting Middle R": LMLocationData("Hidden Room", 272, "Furniture", 300, floor=1,
                                                    update_ram_addr=[LMRamData(in_game_room_id=1)]),
    "Conservatory Picture L": LMLocationData("Conservatory", 273, "Furniture", 124, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=22)]),
    "Conservatory Picture C": LMLocationData("Conservatory", 274, "Furniture", 125, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=22)]),
    "Conservatory Picture R (hangs Lower)": LMLocationData("Conservatory", 275, "Furniture", 135, floor=1,
                                                            update_ram_addr=[LMRamData(in_game_room_id=22)]),
    "Conservatory Picture R (hangs Higher)": LMLocationData("Conservatory", 276, "Furniture", 136, floor=1,
                                                           update_ram_addr=[LMRamData(in_game_room_id=22)]),
    "Dining Room Picture": LMLocationData("Dining Room", 298, "Furniture", 315, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Graveyard Downspout": LMLocationData("Graveyard", 320, "Furniture", 186, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=15)]),
    "2F Rear Hallway Picture": LMLocationData("2F Rear Hallway", 368, "Furniture", 520, floor=2,
                                              update_ram_addr=[LMRamData(in_game_room_id=47)]),
    "2F Washroom Picture": LMLocationData("2F Washroom", 381, "Furniture", 444, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=45)]),
    "Nana's Room Painting": LMLocationData("Nana's Room", 400, "Furniture", 388, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=49)]),
    "Billiards Room L Portrait (near Chest)": LMLocationData("Billiards Room", 414, "Furniture", 153, floor=1,
                                                             update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Billiards Room L Portrait (near Dart Board)": LMLocationData("Billiards Room", 415, "Furniture", 155, floor=1,
                                                                  update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Billiards Room C Portrait": LMLocationData("Billiards Room", 416, "Furniture", 152, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Billiards Room R Portrait": LMLocationData("Billiards Room", 417, "Furniture", 154, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Billiards Room Dart Board": LMLocationData("Billiards Room", 418, "Furniture", 157, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=12)]),
    "Projection Room Projection Screen": LMLocationData("Projection Room", 431, "Furniture", 204, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=13)]),
    "Rec Room SW Crest": LMLocationData("Rec Room", 340, "Furniture", 112, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room NW Crest": LMLocationData("Rec Room", 341, "Furniture", 113, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room SE Crest": LMLocationData("Rec Room", 342, "Furniture", 114, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room NE Crest": LMLocationData("Rec Room", 719, "Furniture", 115, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room L Sandbag": LMLocationData("Rec Room", 344, "Furniture", 253, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room R Sandbag": LMLocationData("Rec Room", 345, "Furniture", 252, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Rec Room C Sandbag": LMLocationData("Rec Room", 346, "Furniture", 251, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=23)]),
    "Armory Wall Shield": LMLocationData("Armory", 527, "Furniture", 637, floor=3,
                                         update_ram_addr=[LMRamData(in_game_room_id=51)]),
    "Safari Room L Deer Head": LMLocationData("Safari Room", 438, "Furniture", 635, floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=55)]),
    "Safari Room R Deer Head": LMLocationData("Safari Room", 440, "Furniture", 634, floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=55)]),
    "Safari Room C Deer Head": LMLocationData("Safari Room", 439, "Furniture", 630, floor=3, remote_only=True,
                                              update_ram_addr=[LMRamData(in_game_room_id=55)]),
    "Sealed Room Mirror": LMLocationData("Sealed Room", 558, "Furniture", 557, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sealed Room Picture": LMLocationData("Sealed Room", 559, "Furniture", 526, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=37)]),
    "Sitting Room Picture": LMLocationData("Sitting Room", 576, "Furniture", 411, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=28)]),
    "Guest Room Painting": LMLocationData("Guest Room", 581, "Furniture", 418, CanFstWater, 2,
                                          update_ram_addr=[LMRamData(in_game_room_id=29)]),
...
SEATING_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Parlor Chair": LMLocationData("Parlor", 100, "Furniture", 338, floor=2,
                                   update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Parlor Couch": LMLocationData("Parlor", 102, "Furniture", 341, floor=2,
                                   update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Study Chair": LMLocationData("Study", 144, "Furniture", 350, floor=2, remote_only=True,
                                  update_ram_addr=[LMRamData(in_game_room_id=35)], require_poltergust=False),
    "Master Bedroom Stool": LMLocationData("Master Bedroom", 158, "Furniture", 376, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=34)], require_poltergust=False,
                                           hide_boo=False),
    "Nursery Chair L": LMLocationData("Nursery", 170, "Furniture", 365, floor=2,
                                      update_ram_addr=[LMRamData(in_game_room_id=26)], require_poltergust=False),
    "Nursery Chair R": LMLocationData("Nursery", 171, "Furniture", 366, floor=2,
                                      update_ram_addr=[LMRamData(in_game_room_id=26)], require_poltergust=False),
    "Twins' Room Chair L (closest to 4th Wall)": LMLocationData("Twins' Room", 189, "Furniture", 428, floor=2,
                                                                update_ram_addr=[LMRamData(in_game_room_id=27)], require_poltergust=False),
    "Twins' Room Chair L (farthest from Desk)": LMLocationData("Twins' Room", 190, "Furniture", 429, floor=2,
                                                               update_ram_addr=[LMRamData(in_game_room_id=27)], require_poltergust=False),
    "Ballroom Chair L (closest to Left Wall)": LMLocationData("Ballroom", 211, "Furniture", 168, floor=1,
                                                              update_ram_addr=[LMRamData(in_game_room_id=9)], require_poltergust=False),
    "Ballroom Chair L (furthest from Left Wall)": LMLocationData("Ballroom", 212, "Furniture", 169, floor=1,
                                                                 update_ram_addr=[LMRamData(in_game_room_id=9)], require_poltergust=False),
    "Ballroom Chair R (furthest from Right Wall)": LMLocationData("Ballroom", 213, "Furniture", 170, floor=1,
                                                                  update_ram_addr=[LMRamData(in_game_room_id=9)], require_poltergust=False),
    "Ballroom Chair R (closest from Right Wall)": LMLocationData("Ballroom", 214, "Furniture", 171, floor=1 ,
                                                                 update_ram_addr=[LMRamData(in_game_room_id=9)], require_poltergust=False),
    "Storage Room Chair Stack": LMLocationData("Storage Room", 217, "Furniture", 162, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=14)], require_poltergust=False),
    "Fortune Teller's Chair": LMLocationData("Fortune-Teller's Room", 230, "Furniture", 116, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Butler's Room Stool (candle on Top)": LMLocationData("Butler's Room", 262, "Furniture", 313, floor=1 ,
                                                          update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Butler's Room Stool (near Sewing Machine)": LMLocationData("Butler's Room", 250, "Furniture", 223, floor=1,
                                                                update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Butler's Room Stool (middle table, R)": LMLocationData("Butler's Room", 251, "Furniture", 224, floor=1,
                                                            update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Butler's Room Stool (middle table, C)": LMLocationData("Butler's Room", 252, "Furniture", 225, floor=1,
                                                            update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Butler's Room Stool (close to Left Wall)": LMLocationData("Butler's Room", 253, "Furniture", 226, floor=1,
                                                               update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Conservatory Harp Chair": LMLocationData("Conservatory", 277, "Furniture", 128, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Cello Chair": LMLocationData("Conservatory", 278, "Furniture", 129, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Conservatory Piano Bench": LMLocationData("Conservatory", 282, "Furniture", 120, floor=1, remote_only=True,
                                               update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Dining Room L Chair": LMLocationData("Dining Room", 292, "Furniture", 86, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Dining Room R Chair": LMLocationData("Dining Room", 293, "Furniture", 87, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=8)]),
    "Mr Lugg's Stool (Dining Room)": LMLocationData("Dining Room", 852, "Furniture", 167, floor=1,
                                                     update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Tea Room Chair (left table, left side near Door)": LMLocationData("Tea Room", 353, "Furniture", 389, floor=2,
                                                                       update_ram_addr=[LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (left table, right side near Door)": LMLocationData("Tea Room", 354, "Furniture", 390, floor=2,
                                                                        update_ram_addr=[
                                                                            LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (right table, left side near Door)": LMLocationData("Tea Room", 355, "Furniture", 391, floor=2,
                                                                        update_ram_addr=[
                                                                            LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (right table, right side near Door)": LMLocationData("Tea Room", 356, "Furniture", 392, floor=2,
                                                                         update_ram_addr=[
                                                                             LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (right table, right side near Window)": LMLocationData("Tea Room", 357, "Furniture", 393, floor=2,
                                                                           update_ram_addr=[
                                                                               LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (right table, left side near Window)": LMLocationData("Tea Room", 358, "Furniture", 394, floor=2,
                                                                          update_ram_addr=[
                                                                              LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (left table, right side near Window)": LMLocationData("Tea Room", 359, "Furniture", 395, floor=2,
                                                                          update_ram_addr=[
                                                                              LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room Chair (left table, left side near Window)": LMLocationData("Tea Room", 360, "Furniture", 396, floor=2,
                                                                         update_ram_addr=[
                                                                             LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Nana's Room Loveseat": LMLocationData("Nana's Room", 391, "Furniture", 387, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Nana's Room Chair": LMLocationData("Nana's Room", 392, "Furniture", 386, floor=2, remote_only=True,
                                        update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Observatory Chair": LMLocationData("Observatory", 718, "Furniture", 470, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=44)], require_poltergust=False),
    "Billiards Room C Chair": LMLocationData("Billiards Room", 411, "Furniture", 149, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Billiards Room L Chair": LMLocationData("Billiards Room", 412, "Furniture", 150, floor=1,
                                             update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Billiards Room R Chair": LMLocationData("Billiards Room", 413, "Furniture", 151, floor=1, remote_only=True,
                                             update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Safari Room Chair": LMLocationData("Safari Room", 432, "Furniture", 627, floor=3,
                                        update_ram_addr=[LMRamData(in_game_room_id=55)], require_poltergust=False),
    "Balcony West Bench": LMLocationData("Balcony", 441, "Furniture", 617, floor=3,
                                         update_ram_addr=[LMRamData(in_game_room_id=62)], require_poltergust=False),
    "Balcony East Bench": LMLocationData("Balcony", 442, "Furniture", 618, floor=3,
                                         update_ram_addr=[LMRamData(in_game_room_id=62)], require_poltergust=False),
    "Telephone Room Couch": LMLocationData("Telephone Room", 478, "Furniture", 674, floor=3,
                                           update_ram_addr=[LMRamData(in_game_room_id=53)], require_poltergust=False),
    "Clockwork Room L Chair": LMLocationData("Clockwork Room", 490, "Furniture", 600, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room R Chair": LMLocationData("Clockwork Room", 491, "Furniture", 597, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room C Chair": LMLocationData("Clockwork Room", 492, "Furniture", 601, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room R Stool": LMLocationData("Clockwork Room", 493, "Furniture", 598, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room L Stool": LMLocationData("Clockwork Room", 494, "Furniture", 599, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Ceramics Studio Chair": LMLocationData("Ceramics Studio", 532, "Furniture", 659, floor=3,
                                            update_ram_addr=[LMRamData(in_game_room_id=58)], require_poltergust=False),
    "Sitting Room Couch": LMLocationData("Sitting Room", 573, "Furniture", 415, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=28)], require_poltergust=False),
    "Sitting Room Chair": LMLocationData("Sitting Room", 574, "Furniture", 414, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=28)], require_poltergust=False),
    "Guest Room Chair": LMLocationData("Guest Room", 577, "Furniture", 422, CanFstWater, 2,
                                       update_ram_addr=[LMRamData(in_game_room_id=29)]),
    "Artist's Studio Stools": LMLocationData("Artist's Studio", 598, "Furniture", 689, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=60)], require_poltergust=False),
    "Storage Room Chair": LMLocationData("Storage Room", 209, "Furniture", 161, floor=1, remote_only=True,
                                         update_ram_addr=[LMRamData(in_game_room_id=14)], require_poltergust=False),
}

SURFACES_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Parlor Wine Table": LMLocationData("Parlor", 101, "Furniture", 339, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Parlor Table": LMLocationData("Parlor", 103, "Furniture", 340, floor=2,
                                   update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Study Desk": LMLocationData("Study", 143, "Furniture", 351, floor=2,
                                 update_ram_addr=[LMRamData(in_game_room_id=35)], require_poltergust=False),
    "Master Bedroom Bed": LMLocationData("Master Bedroom", 141, "Furniture", 360, floor=2 ,
                                         update_ram_addr=[LMRamData(in_game_room_id=34)], require_poltergust=False),
    "Nursery Table": LMLocationData("Nursery", 172, "Furniture", 371, floor=2,
                                    update_ram_addr=[LMRamData(in_game_room_id=26)], require_poltergust=False),
    "Twins' Room Desk": LMLocationData("Twins' Room", 186, "Furniture", 427, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=27)], require_poltergust=False),
    "Clairvoya's Crystal Ball (Fortune-Teller's Room)": LMLocationData("Fortune-Teller's Room", 231, "Furniture", 117,
                                                                       floor=1,
                                                                       update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Butler's Room Table": LMLocationData("Butler's Room", 249, "Furniture", 221, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Butler's Room Ironing Board": LMLocationData("Butler's Room", 260, "Furniture", 229, floor=1,
                                                  update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Butler's Room Sewing Machine": LMLocationData("Butler's Room", 261, "Furniture", 222, floor=1 ,
                                                   update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Melody's Piano (Conservatory)": LMLocationData("Conservatory", 281, "Furniture", 130, floor=1 ,
                                                    update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Dining Room Table": LMLocationData("Dining Room", 299, "Furniture", 105, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Kitchen Table": LMLocationData("Kitchen", 312, "Furniture", 83, floor=1,
                                    update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Nana's Room Sewing Machine": LMLocationData("Nana's Room", 389, "Furniture", 384, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Nana's Room Coffee Table": LMLocationData("Nana's Room", 393, "Furniture", 383, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Slim's Pool Table (Billiards Room)": LMLocationData("Billiards Room", 409, "Furniture", 147, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Billiards Room Chess Table": LMLocationData("Billiards Room", 410, "Furniture", 148, floor=1,
                                                 update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Projection Room Projector Table": LMLocationData("Projection Room", 426, "Furniture", 203, floor=1,
                                                      update_ram_addr=[LMRamData(in_game_room_id=13)]),
    "Telephone Room Table": LMLocationData("Telephone Room", 477, "Furniture", 673, floor=3,
                                           update_ram_addr=[LMRamData(in_game_room_id=53)], require_poltergust=False),
    "Clockwork Room Bee-Hat Clocks": LMLocationData("Clockwork Room", 495, "Furniture", 656, floor=3,
                                                    update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room Woman-Windmill Clocks": LMLocationData("Clockwork Room", 496, "Furniture", 622,  floor=3,
                                                           update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room Cuckoo Clock": LMLocationData("Clockwork Room", 497, "Furniture", 624, floor=3,
                                                  update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Clockwork Room Table with Head": LMLocationData("Clockwork Room", 498, "Furniture", 623, floor=3,
                                                     update_ram_addr=[LMRamData(in_game_room_id=59)], require_poltergust=False),
    "Sealed Room Table": LMLocationData("Sealed Room", 560, "Furniture", 464, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=37)], require_poltergust=False),
    "Sitting Room Table": LMLocationData("Sitting Room", 575, "Furniture", 412, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=28)], require_poltergust=False),
    "Sue Pea's Bed (Guest Room)": LMLocationData("Guest Room", 578, "Furniture", 420, CanFstWater, 2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=29)]),
    "Tea Room West Table": LMLocationData("Tea Room", 862, "Furniture", 538, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "Tea Room East Table": LMLocationData("Tea Room", 863, "Furniture", 539, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "Twins' Room Bunk Bed": LMLocationData("Twins' Room", 182, "Furniture", 425, floor=2, remote_only=True,
                                           update_ram_addr=[LMRamData(in_game_room_id=27)], require_poltergust=False),
...
STORAGE_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Study Hat Rack": LMLocationData("Study", 139, "Furniture", 348, floor=2,
                                     update_ram_addr=[LMRamData(in_game_room_id=35)], require_poltergust=False),
    "Wardrobe Shoe Rack": LMLocationData("Wardrobe", 124, "Furniture", 453, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=41)], require_poltergust=False),
    "Wardrobe Hat Stand": LMLocationData("Wardrobe", 125, "Furniture", 495, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=41)], require_poltergust=False),
    "Study Bookshelf (far left)": LMLocationData("Study", 151, "Furniture", 354, floor=2,
                                                 update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Bookshelf (second from left)": LMLocationData("Study", 152, "Furniture", 355, floor=2,
                                                         update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Bookshelf (third from left)": LMLocationData("Study", 153, "Furniture", 356, floor=2,
                                                        update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Bookshelf (third from right)": LMLocationData("Study", 154, "Furniture", 357, floor=2,
                                                         update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Bookshelf (second from right)": LMLocationData("Study", 155, "Furniture", 358, floor=2,
                                                          update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "Study Bookshelf (far right)": LMLocationData("Study", 156, "Furniture", 359, floor=2,
                                                  update_ram_addr=[LMRamData(in_game_room_id=35)]),
    "1F Washroom Water Tank (above Toilet)": LMLocationData("1F Washroom", 206, "Furniture", 92, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=16)], remote_only=True),
    "1F Bathroom Shelf": LMLocationData("1F Bathroom", 199, "Furniture", 304, floor=1,
                                        update_ram_addr=[LMRamData(in_game_room_id=21)]),
    "Storage Room Bucket": LMLocationData("Storage Room", 215, "Furniture", 165, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=14)], require_poltergust=False),
    "Storage Room Crate (bottom row, L)": LMLocationData("Storage Room", 218, "Furniture", 259, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (bottom row, back L)": LMLocationData("Storage Room", 219, "Furniture", 260, floor=1,
                                                              update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (bottom row, back R)": LMLocationData("Storage Room", 220, "Furniture", 261, floor=1,
                                                              update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (bottom row, C)": LMLocationData("Storage Room", 221, "Furniture", 262, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (bottom row, R)": LMLocationData("Storage Room", 222, "Furniture", 263, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (middle row, R)": LMLocationData("Storage Room", 223, "Furniture", 264, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (middle row, L)": LMLocationData("Storage Room", 224, "Furniture", 265, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Storage Room Crate (top row)": LMLocationData("Storage Room", 225, "Furniture", 266, floor=1,
                                                   update_ram_addr=[LMRamData(in_game_room_id=14)]),
    "Laundry Room Bucket": LMLocationData("Laundry Room", 242, "Furniture", 193, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=5)]),
    "Laundry Room West Soap Shelf": LMLocationData("Laundry Room", 247, "Furniture", 189, floor=1,
                                                   update_ram_addr=[LMRamData(in_game_room_id=5)]),
    "Laundry Room East Soap Shelf": LMLocationData("Laundry Room", 248, "Furniture", 190, floor=1,
                                                   update_ram_addr=[LMRamData(in_game_room_id=5)]),
    "Laundry Room Laundry Basket": LMLocationData("Laundry Room", 244, "Furniture", 191, floor=1,
                                                  update_ram_addr=[LMRamData(in_game_room_id=5)], require_poltergust=False),
    "Butler's Room Mop Bucket": LMLocationData("Butler's Room", 254, "Furniture", 218, floor=1,
                                               update_ram_addr=[LMRamData(in_game_room_id=0)]),
    "Butler's Room Bucket": LMLocationData("Butler's Room", 258, "Furniture", 227, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=0)]),
    "Kitchen L Food Shelf": LMLocationData("Kitchen", 310, "Furniture", 76, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Kitchen R Food Shelf": LMLocationData("Kitchen", 311, "Furniture", 77, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Kitchen Utensils Rack": LMLocationData("Kitchen", 313, "Furniture", 81, floor=1,
                                            update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Tea Room Ice Bucket": LMLocationData("Tea Room", 350, "Furniture", 550, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=50)]),
    "2F Washroom Shelf": LMLocationData("2F Washroom", 379, "Furniture", 438, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=45)]),
    "Safari Room Top Boxes": LMLocationData("Safari Room", 434, "Furniture", 626, floor=3,
                                            update_ram_addr=[LMRamData(in_game_room_id=55)]),
    "Safari Room Bottom Boxes": LMLocationData("Safari Room", 435, "Furniture", 625, floor=3,
                                               update_ram_addr=[LMRamData(in_game_room_id=55)]),
    ...
    "Cellar R Shelf": LMLocationData("Cellar", 476, "Furniture", 8,
                                     update_ram_addr=[LMRamData(in_game_room_id=66)], require_poltergust=False),
    "Telephone Room R Shelf": LMLocationData("Telephone Room", 483, "Furniture", 677, floor=3 ,
                                             update_ram_addr=[LMRamData(in_game_room_id=53)]),
    "Telephone Room L Shelf": LMLocationData("Telephone Room", 484, "Furniture", 676, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=53)]),
    "Telephone Room C Shelf": LMLocationData("Telephone Room", 485, "Furniture", 675, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=53)]),
    "Armory Crates (near Ceramics Door)": LMLocationData("Armory", 528, "Furniture", 638, floor=3,
                                                         update_ram_addr=[LMRamData(in_game_room_id=51)]),
    "Armory Crates (front left corner)": LMLocationData("Armory", 529, "Furniture", 639, floor=3,
                                                        update_ram_addr=[LMRamData(in_game_room_id=51)]),
    "Armory Crates (middle left)": LMLocationData("Armory", 530, "Furniture", 640, floor=3,
                                                  update_ram_addr=[LMRamData(in_game_room_id=51)]),
    "Armory Crates (back left corner)": LMLocationData("Armory", 531, "Furniture", 641, floor=3,
                                                       update_ram_addr=[LMRamData(in_game_room_id=51)]),
    "Ceramics Studio Boxes (top, back Wall)": LMLocationData("Ceramics Studio", 536, "Furniture", 664, floor=3,
                                                             update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Boxes (bottom, back Wall)": LMLocationData("Ceramics Studio", 537, "Furniture", 665, floor=3,
                                                                update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Ceramics Studio Boxes (left corner near 4th Wall)": LMLocationData("Ceramics Studio", 538, "Furniture", 670, floor=3,
        update_ram_addr=[LMRamData(in_game_room_id=58)]),
    "Sitting Room Hat Stand": LMLocationData("Sitting Room", 571, "Furniture", 413, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=28)], require_poltergust=False),
...
DRAWERS_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Foyer Dresser": LMLocationData("Foyer", 93, "Furniture", 207, floor=1,
                                    update_ram_addr=[LMRamData(in_game_room_id=2)], require_poltergust=False),
    "Parlor China Cabinet": LMLocationData("Parlor", 105, "Furniture", 337, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Parlor Book Hutch": LMLocationData("Parlor", 106, "Furniture", 494, floor=2,
                                        update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Parlor End Table": LMLocationData("Parlor", 111, "Furniture", 489, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Sitting Room Water Pot": LMLocationData("Sitting Room", 572, "Furniture", 410, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=28)], require_poltergust=False),
    "Anteroom R End Table": LMLocationData("Anteroom", 117, "Furniture", 486, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=42)], require_poltergust=False),
    "Anteroom C End Table": LMLocationData("Anteroom", 118, "Furniture", 514, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=42)], require_poltergust=False),
    "Anteroom L End Table": LMLocationData("Anteroom", 119, "Furniture", 513, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=42)], require_poltergust=False),
    "Wardrobe Center Dresser": LMLocationData("Wardrobe", 128, "Furniture", 478, floor=2,
                                              update_ram_addr=[LMRamData(in_game_room_id=41)], require_poltergust=False),
    "Master Bedroom Dresser": LMLocationData("Master Bedroom", 157, "Furniture", 491, floor=2,
                                             update_ram_addr=[LMRamData(in_game_room_id=34)], require_poltergust=False),
    "Master Bedroom End Table": LMLocationData("Master Bedroom", 160, "Furniture", 492, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=34)], require_poltergust=False),
    "Nursery Heart Dresser": LMLocationData("Nursery", 169, "Furniture", 367, floor=2,
                                            update_ram_addr=[LMRamData(in_game_room_id=26)], require_poltergust=False),
    "Twins' Room Dresser": LMLocationData("Twins' Room", 192, "Furniture", 515, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=27)], require_poltergust=False),
    "1F Washroom Cabinet": LMLocationData("1F Washroom", 204, "Furniture", 232, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=16)]),
    "Fortune Teller's Room West Dresser": LMLocationData("Fortune-Teller's Room", 226, "Furniture", 196, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Fortune Teller's Room East Dresser": LMLocationData("Fortune-Teller's Room", 227, "Furniture", 209, floor=1,
                                                         update_ram_addr=[LMRamData(in_game_room_id=3)], require_poltergust=False),
    "Mirror Room Drawer": LMLocationData("Mirror Room", 234, "Furniture", 286, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=4)], require_poltergust=False),
    "Laundry Room Cabinet": LMLocationData("Laundry Room", 245, "Furniture", 188, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=5)], require_poltergust=False),
    "Butler's Room Cabinet": LMLocationData("Butler's Room", 259, "Furniture", 217, floor=1,
                                            update_ram_addr=[LMRamData(in_game_room_id=0)], require_poltergust=False),
    "Conservatory Cabinet": LMLocationData("Conservatory", 291, "Furniture", 197, floor=1,
                                           update_ram_addr=[LMRamData(in_game_room_id=22)], require_poltergust=False),
    "Dining Room R China Hutch": LMLocationData("Dining Room", 295, "Furniture", 279, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Kitchen China Hutch": LMLocationData("Kitchen", 309, "Furniture", 79, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=7)], require_poltergust=False),
    "Rec Room Drawer": LMLocationData("Rec Room", 337, "Furniture", 198, floor=1,
                                      update_ram_addr=[LMRamData(in_game_room_id=23)], require_poltergust=False),
    "Tea Room L Drawers": LMLocationData("Tea Room", 363, "Furniture", 516, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Tea Room R Drawers": LMLocationData("Tea Room", 364, "Furniture", 517, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=50)], require_poltergust=False),
    "Nana's Room Dresser": LMLocationData("Nana's Room", 390, "Furniture", 482, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=49)], require_poltergust=False),
    "Astral Hall Right Dresser": LMLocationData("Astral Hall", 394, "Furniture", 484, floor=2,
                                                update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Astral Hall Left Dresser": LMLocationData("Astral Hall", 402, "Furniture", 483, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=43)], require_poltergust=False),
    "Observatory Dresser": LMLocationData("Observatory", 717, "Furniture", 469, floor=2,
                                          update_ram_addr=[LMRamData(in_game_room_id=44)], require_poltergust=False),
    "Billiards Room End Table (near Chest)": LMLocationData("Billiards Room", 419, "Furniture", 290, floor=1,
                                                            update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Billiards Room End Table (near Dart Board)": LMLocationData("Billiards Room", 420, "Furniture", 289, floor=1,
                                                                 update_ram_addr=[LMRamData(in_game_room_id=12)], require_poltergust=False),
    "Projection Room Cabinet": LMLocationData("Projection Room", 424, "Furniture", 205, floor=1,
                                              update_ram_addr=[LMRamData(in_game_room_id=13)], require_poltergust=False),
    "Telephone Room L Cabinet": LMLocationData("Telephone Room", 481, "Furniture", 678, floor=3,
                                               update_ram_addr=[LMRamData(in_game_room_id=53)], require_poltergust=False),
    "Telephone Room R Cabinet": LMLocationData("Telephone Room", 482, "Furniture", 679, floor=3,
                                               update_ram_addr=[LMRamData(in_game_room_id=53)], require_poltergust=False),
    "Guest Room End Table": LMLocationData("Guest Room", 580, "Furniture", 497, CanFstWater, 2,
                                           update_ram_addr=[LMRamData(in_game_room_id=29)]),
    "Wardrobe West Dresser": LMLocationData("Wardrobe", 127, "Furniture", 479, floor=2, remote_only=True,
                                                update_ram_addr=[LMRamData(in_game_room_id=41)], require_poltergust=False),
    "Wardrobe Right Dresser": LMLocationData("Wardrobe", 871, "Furniture", 477, floor=2, remote_only=True,
                                             update_ram_addr=[LMRamData(in_game_room_id=41)], require_poltergust=False),
    "Dining Room L China Hutch": LMLocationData("Dining Room", 294, "Furniture", 278, floor=1, remote_only=True,
                                                update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
}
...
TREASURES_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Heart Door Lamp": LMLocationData("Foyer", 94, "Furniture", 270, floor=1,
        update_ram_addr=[LMRamData(in_game_room_id=2)]),
    "Foyer Chandelier": LMLocationData("Foyer", 95, "Furniture", 101, floor=2,
        update_ram_addr=[LMRamData(in_game_room_id=2)]),
    "Parlor Book Hutch": LMLocationData("Parlor", 106, "Furniture", 494, floor=2,
        update_ram_addr=[LMRamData(in_game_room_id=36)], require_poltergust=False),
    "Parlor Chandelier": LMLocationData("Parlor", 104, "Furniture", 342, floor=2,
    ...
    "Dining Room R China Hutch": LMLocationData("Dining Room", 295, "Furniture", 279, floor=1,
                                                update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Kitchen Oven": LMLocationData("Kitchen", 307, "Furniture", 80, CanFstFire, floor=1,
                                   update_ram_addr=[LMRamData(in_game_room_id=7)]),
    "Kitchen China Hutch": LMLocationData("Kitchen", 309, "Furniture", 79, floor=1,
                                          update_ram_addr=[LMRamData(in_game_room_id=7)], require_poltergust=False),
    "Kitchen R Ceiling Light": LMLocationData("Kitchen", 316, "Furniture", 85, floor=1,
    ...
    "Pipe Room Bucket": LMLocationData("Pipe Room", 594, "Furniture", 22,
                                       update_ram_addr=[LMRamData(in_game_room_id=68)]),
    "Guest Room End Table": LMLocationData("Guest Room", 580, "Furniture", 497, CanFstWater, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=29)]),
    "Secret Altar Brazier (near front, closest to 4th Wall)": LMLocationData("Secret Altar", 610, "Furniture", 28,
                                                                             update_ram_addr=[
    ...
    "Wardrobe Balcony Plant L (next to Toad)": LMLocationData("Wardrobe Balcony", 66, "Plant", 474,
                                                              CanFstWater, floor=2,
                                                              update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Wardrobe Balcony Plant C": LMLocationData("Wardrobe Balcony", 67, "Plant", 475, CanFstWater, floor=2,
                                               update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Wardrobe Balcony Plant L (in Corner)": LMLocationData("Wardrobe Balcony", 68, "Plant", 476,
                                                           CanFstWater, floor=2,
                                                           update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Master Bedroom Plant": LMLocationData("Master Bedroom", 69, "Plant", 542, CanFstWater, floor=2,
                                           update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard SW Plant": LMLocationData("Courtyard", 71, "Plant", 142, CanFstWater, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard NW Plant": LMLocationData("Courtyard", 72, "Plant", 143, CanFstWater, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard NE Plant": LMLocationData("Courtyard", 73, "Plant", 144, CanFstWater, floor=1,
                                         update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Balcony Plant NW Not Near Bench": LMLocationData("Balcony", 75, "Plant", 604, CanFstWater, floor=3,
                                                      update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant E Railing": LMLocationData("Balcony", 76, "Plant", 605, CanFstWater,floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Near Bench": LMLocationData("Balcony", 77, "Plant", 606, CanFstWater,floor=3,
                                                  update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant SW Corner": LMLocationData("Balcony", 81, "Plant", 610, CanFstWater,floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Corner": LMLocationData("Balcony", 82, "Plant", 611, CanFstWater,floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony West Double Plant": LMLocationData("Balcony", 83, "Plant", 612, CanFstWater,floor=3,
                                                update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Center R": LMLocationData("Balcony", 84, "Plant", 613, CanFstWater,floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Directly in NE Corner": LMLocationData("Balcony", 872, "Plant", 608, CanFstWater, floor=3,
                                      update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant SE Corner": LMLocationData("Balcony", 80, "Plant", 609, CanFstWater,  floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Second from Right Plant near NW Bench": LMLocationData("Balcony", 873, "Plant", 615, CanFstWater, floor=3,
                                       update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Furthest Right Plant near NW Bench": LMLocationData("Balcony", 874, "Plant", 614, CanFstWater, floor=3,
                                       update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Second from Right in NE Corner": LMLocationData("Balcony", 875, "Plant", 616, CanFstWater, floor=3,
                                       update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Center L": LMLocationData("Balcony", 88, "Plant", 712, CanFstWater, floor=3,
                                             update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Third from Right in NE Corner": LMLocationData("Balcony", 876, "Plant", 713, CanFstWater, floor=3,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Sitting Room Plant": LMLocationData("Sitting Room", 91, "Plant", 409, CanFstWater, floor=2,
                                         update_ram_addr=[LMRamData(in_game_room_id=28)]),
    "Guest Room Plant": LMLocationData("Guest Room", 92, "Plant", 417, CanFstWater, floor=2,
                                       update_ram_addr=[LMRamData(in_game_room_id=29)]),
}
...
WDYM_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Roof Entry Hut": LMLocationData("Roof", 854, "Furniture", 716,
        update_ram_addr=[LMRamData(in_game_room_id=63)], require_poltergust=False),
    "Graveyard East Tree": LMLocationData("Graveyard", 855, "Furniture", 184, CanFstWater,
        update_ram_addr=[LMRamData(in_game_room_id=15)]),
    "Graveyard West Tree": LMLocationData("Graveyard", 856, "Furniture", 185, CanFstWater,
        update_ram_addr=[LMRamData(in_game_room_id=15)]),
    "Courtyard Tree by Woman Statue": LMLocationData("Courtyard", 857, "Plant", 139, CanFstWater,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard Tree by Fountain": LMLocationData("Courtyard", 858, "Plant", 140, CanFstWater,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard Tree by Well": LMLocationData("Courtyard", 859, "Plant", 138, CanFstWater,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard Far West Tree": LMLocationData("Courtyard", 860, "Plant", 141, CanFstWater,
        update_ram_addr=[LMRamData(in_game_room_id=24)]),
    ...
    "Basement Stairwell Wall Rails": LMLocationData("Basement Stairwell", 938, "Furniture", 61,
        update_ram_addr=[LMRamData(in_game_room_id=67)]),
    "Pipe Room Metal Rail": LMLocationData("Pipe Room", 939, "Furniture", 69, CanFstIce,
        update_ram_addr=[LMRamData(in_game_room_id=68)]),
...
PORTRAIT_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Henry and Orville, the Twin Brothers": LMLocationData("Twins' Room", 624, "Portrait", 79, HasKey(28), remote_only=True,
    ...
    "Shivers, the Wandering Butler": LMLocationData("Butler's Room", 626, "Portrait", 29, Has("Shivers Spawn") & CanFstFire,
        remote_only=True, update_ram_addr=[LMRamData(0x803D5DA5, bit_position=6, in_game_room_id=0)], health_addr_offset=10),
    "Madame Clairvoya, the Freaky Fortune-Teller": LMLocationData("Fortune-Teller's Room", 627, "Portrait", 31, HasMarioItems,
    ...
    "Mr. Luggs, the Glutton": LMLocationData("Dining Room", 629, "Portrait", 27, CanFstFire,
        remote_only=True, update_ram_addr=[LMRamData(0x803D5DA9, bit_position=4, in_game_room_id=8)], health_addr_offset=14),
    "Spooky, the Guard Dog": LMLocationData("Boneyard", 630, "Portrait", 23, CanFstWater, remote_only=True,
    ...
    "Miss Petunia, the Bathing Beauty": LMLocationData("2F Bathroom", 634, "Portrait", 83, CanFstIce,
    ...
    "Sue Pea, the Dozing Girl": LMLocationData("Guest Room", 636, "Portrait", 78, CanFstWater,
        remote_only=True, update_ram_addr=[LMRamData(0x803D5DB9, bit_position=5, in_game_room_id=29)], health_addr_offset=34),
    "Uncle Grimmly, Hermit of the Darkness": LMLocationData("Wardrobe", 637, "Portrait", 16, Has("Blackout"),
        remote_only=True, update_ram_addr=[LMRamData(0x803D5DBB, bit_position=3, in_game_room_id=41)], health_addr_offset=38),
    "Boolossus, the Jumbo Ghost": LMLocationData("Balcony", 638, "Portrait", 56, VacnIce,
        remote_only=True, update_ram_addr=[LMRamData(0x803D5DBF, bit_position=4, in_game_room_id=62)], map_id=[2,11]),
    "Jarvis, the Jar Collector": LMLocationData("Ceramics Studio", 639, "Portrait", 0, CanFstIce,
    ...
    "Sir Weston, the Chilly Climber": LMLocationData("Cold Storage", 642, "Portrait", 1, CanFstFire, remote_only=True,
...
SPEEDY_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Wardrobe Speedy Spirit": LMLocationData("Wardrobe", 643, "BSpeedy", 128, Has("Blackout"),  remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC3, bit_position=0, in_game_room_id=41)]),
    "Study Speedy Spirit": LMLocationData("Study", 644, "BSpeedy", 113,  Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=2, in_game_room_id=35)]),
    "Nursery Speedy Spirit": LMLocationData("Nursery", 645, "BSpeedy", 148, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC3, bit_position=5, in_game_room_id=26)]),
    "Storage Room Speedy Spirit": LMLocationData("Storage Room", 646, "BSpeedy", 58, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC1, bit_position=7, in_game_room_id=14)]),
    "Hidden Room Speedy Spirit": LMLocationData("Hidden Room", 647, "BSpeedy", 72, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC3, bit_position=3, in_game_room_id=1)]),
    "Conservatory Speedy Spirit": LMLocationData("Conservatory", 648, "BSpeedy", 113, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC3, bit_position=4, in_game_room_id=22)]),
    "Dining Room Speedy Spirit": LMLocationData("Dining Room", 649, "BSpeedy", 60, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=1, in_game_room_id=8)]),
    "Kitchen Speedy Spirit": LMLocationData("Kitchen", 650, "BSpeedy", 66, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=5, in_game_room_id=7)]),
    "Rec Room Speedy Spirit": LMLocationData("Rec Room", 651, "BSpeedy", 67, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=7, in_game_room_id=23)]),
    "Nana's Room Speedy Spirit": LMLocationData("Nana's Room", 652, "BSpeedy", 115, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=4, in_game_room_id=49)]),
    "Billiards Room Speedy Spirit": LMLocationData("Billiards Room", 653, "BSpeedy", 59, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=0, in_game_room_id=12)]),
    "Twins' Room Speedy Spirit": LMLocationData("Twins' Room", 655, "BSpeedy", 114, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=3, in_game_room_id=27)]),
    "Breaker Room Speedy Spirit": LMLocationData("Breaker Room", 656, "BSpeedy", 7, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC3, bit_position=2, in_game_room_id=69)]),
    "Cellar Speedy Spirit": LMLocationData("Cellar", 657, "BSpeedy", 6, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC3, bit_position=1, in_game_room_id=66)]),
    "Sealed Room Speedy Spirit": LMLocationData("Sealed Room", 658, "BSpeedy", 125, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC2, bit_position=6, in_game_room_id=37)]),
}

GOLD_MICE_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Study Cheese Gold Mouse":        LMLocationData("Study", 659, "Mouse", 75, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC4, bit_position=4)]),
    "Fortune Teller Cheese Mouse":    LMLocationData("Fortune-Teller's Room", 660, "Mouse", 52, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC4, bit_position=3)]),
    "Dining Room Cheese Mouse":       LMLocationData("Dining Room", 661, "Mouse", 53, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DB1, bit_position=7)]),
    "Tea Room Cheese Mouse":          LMLocationData("Tea Room", 662, "Mouse", 72, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC4, bit_position=5)]),
    "Safari Room Cheese Mouse":       LMLocationData("Safari Room", 663, "Mouse", 82, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC4, bit_position=6)]),
    "1F Hallway Chance Mouse":        LMLocationData("1F Hallway", 664, "Mouse", 49, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DC4, bit_position=7)]),
    "Kitchen Chance Mouse":           LMLocationData("Kitchen", 665, "Mouse", 8, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DB1, bit_position=4)]),
    "Tea Room Chance Mouse":          LMLocationData("Tea Room", 666, "Mouse", 76, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DB1, bit_position=5)]),
    "2F Rear Hallway Chance Mouse":   LMLocationData("2F Rear Hallway", 667, "Mouse", 71, Has("Blackout"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5DB1, bit_position=3)]),
    "Sealed Room Chance Mouse":       LMLocationData("Sealed Room", 668, "Mouse", 73, Has("Blackout"), remote_only=True,
...
ROOM_BOO_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Butler's Room Boo": LMLocationData("Butler's Room", 677, "Boo", 0,
                                        Has("Shivers Spawn") & CanFstFire & Has("Boo Radar"),
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E04, bit_position=0)]),
    "Hidden Room Boo": LMLocationData("Hidden Room", 678, "Boo", 1, Has("Boo Radar"), remote_only=True,
    ...
    "Fortune-Teller's Room Boo": LMLocationData("Fortune-Teller's Room", 679, "Boo", 2,
                                                HasMarioItems & Has("Boo Radar") & (HasKey(4)|HasKey(5)),
                                                remote_only=True, update_ram_addr=[LMRamData(0x803D5E04, bit_position=2)]),
    "Mirror Room Boo": LMLocationData("Mirror Room", 680, "Boo", 3, Has("Boo Radar") & HasKey(5), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E04, bit_position=3)]),
    "Laundry Room Boo": LMLocationData("Laundry Room", 676, "Boo", 4,
                                       Has("Boo Radar") & (HasKey(1)|HasKey(7)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E04, bit_position=4)]),
    "Kitchen Boo": LMLocationData("Kitchen", 684, "Boo", 5, Has("Boo Radar") & (HasKey(10)|HasKey(11)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E04, bit_position=5)]),
    "Dining Room Boo": LMLocationData("Dining Room", 683, "Boo", 6,
                                      CanFstFire & Has("Boo Radar") & (HasKey(11)|HasKey(14)),
                                      remote_only=True, update_ram_addr=[LMRamData(0x803D5E04, bit_position=6)]),
    "Ballroom Boo": LMLocationData("Ballroom", 681, "Boo", 7, Has("Boo Radar") & (HasKey(15)|HasKey(16)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E04, bit_position=7)]),
    "Billiards Room Boo": LMLocationData("Billiards Room", 687, "Boo", 8, Has("Boo Radar") & (HasKey(18)|HasKey(17)),
                                         remote_only=True, update_ram_addr=[LMRamData(0x803D5E05, bit_position=0)]),
    "Projection Room Boo": LMLocationData("Projection Room", 688, "Boo", 9, Has("Boo Radar") & HasKey(18), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E05, bit_position=1)]),
    "Storage Room Boo": LMLocationData("Storage Room", 682, "Boo", 10, Has("Boo Radar") & HasKey(16), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E05, bit_position=2)]),
    "Conservatory Boo": LMLocationData("Conservatory", 685, "Boo", 11, Has("Boo Radar") & HasKey(21), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E05, bit_position=3)]),
    "Rec Room Boo": LMLocationData("Rec Room", 686, "Boo", 12, Has("Boo Radar") & (HasKey(24)|HasKey(25)),
                                   remote_only=True, update_ram_addr=[LMRamData(0x803D5E05, bit_position=4)]),
    "Nursery Boo": LMLocationData("Nursery", 674, "Boo", 13, HasKey(27) & Has("Boo Radar"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E05, bit_position=5)]),
    "Twins' Room Boo": LMLocationData("Twins' Room", 675, "Boo", 14, HasKey(28) & Has("Boo Radar"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E05, bit_position=6)]),
    "Sitting Room Boo": LMLocationData("Sitting Room", 691, "Boo", 15,
                                       CanFstFire & CanFstWater & Has("Boo Radar") & (HasKey(29)|HasKey(30)),
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E05, bit_position=7)]),
    "Guest Room Boo": LMLocationData("Guest Room", 692, "Boo", 16, CanFstWater & Has("Boo Radar") & HasKey(30),
                                     remote_only=True, update_ram_addr=[LMRamData(0x803D5E06, bit_position=0)]),
    "Master Bedroom Boo": LMLocationData("Master Bedroom", 673, "Boo", 17, Has("Boo Radar") & HasKey(31), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E06, bit_position=1)]),
    "Study Boo": LMLocationData("Study", 672, "Boo", 18, Has("Boo Radar") & HasKey(32), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E06, bit_position=2)]),
    "Parlor Boo": LMLocationData("Parlor", 669, "Boo", 19, (HasKey(34)|HasKey(38)) & Has("Boo Radar"), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E06, bit_position=3)]),
    "Wardrobe Boo": LMLocationData("Wardrobe", 671, "Boo", 20, Has("Boo Radar") & (HasKey(43)|HasKey(41)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E06, bit_position=4)]),
    "Anteroom Boo": LMLocationData("Anteroom", 670, "Boo", 21, Has("Boo Radar") & (HasKey(43)|HasKey(38)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E06, bit_position=5)]),
    "Astral Hall Boo": LMLocationData("Astral Hall", 699, "Boo", 22, CanFstFire & Has("Boo Radar") & (HasKey(44)|HasKey(40)),
                                      remote_only=True, update_ram_addr=[LMRamData(0x803D5E06, bit_position=6)]),
    "Nana's Room Boo": LMLocationData("Nana's Room", 690, "Boo", 23, Has("Boo Radar") & HasKey(49), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E06, bit_position=7)]),
    "Tea Room Boo": LMLocationData("Tea Room", 689, "Boo", 24, Has("Boo Radar") & HasKey(47), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E07, bit_position=0)]),
    "Armory Boo": LMLocationData("Armory", 695, "Boo", 25, Has("Boo Radar") & (HasKey(51)|HasKey(50)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E07, bit_position=1)]),
    "Telephone Room Boo": LMLocationData("Telephone Room", 697, "Boo", 26, Has("Boo Radar") &(HasKey(52)|HasKey(53)),
                                         remote_only=True, update_ram_addr=[LMRamData(0x803D5E07, bit_position=2)]),
    "Safari Room Boo": LMLocationData("Safari Room", 693, "Boo", 27, Has("Boo Radar") & (HasKey(56)|HasKey(55)),
                                      remote_only=True, update_ram_addr=[LMRamData(0x803D5E07, bit_position=3)]),
    "Ceramics Studio Boo": LMLocationData("Ceramics Studio", 696, "Boo", 28, CanFstIce & Has("Boo Radar") & HasKey(50),
                                          remote_only=True, update_ram_addr=[LMRamData(0x803D5E07, bit_position=4)]),
    "Clockwork Room Boo": LMLocationData("Clockwork Room", 698, "Boo", 29, Has("Boo Radar") & Has("Defeat Clockwork"),
                                         remote_only=True, update_ram_addr=[LMRamData(0x803D5E07, bit_position=5)]),
    "Artist's Studio Boo": LMLocationData("Artist's Studio", 694, "Boo", 30, Has("Boo Radar") & HasKey(63),
                                          remote_only=True, update_ram_addr=[LMRamData(0x803D5E07, bit_position=6)]),
    "Cold Storage Boo": LMLocationData("Cold Storage", 703, "Boo", 31, CanFstFire & Has("Boo Radar") & HasKey(65),
                                       remote_only=True, update_ram_addr=[LMRamData(0x803D5E07, bit_position=7)]),
    "Cellar Boo": LMLocationData("Cellar", 701, "Boo", 32, Has("Boo Radar") & (HasKey(68)|HasKey(67)), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=0)]),
    "Pipe Room Boo": LMLocationData("Pipe Room", 702, "Boo", 33, Has("Boo Radar") & HasKey(69), remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=1)]),
    "Breaker Room Boo": LMLocationData("Breaker Room", 700, "Boo", 34, Has("Boo Radar") & HasKey(71), remote_only=True,
...
BOOLOSSUS_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Boolossus Fragment 1": LMLocationData("Balcony", 720, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=3, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 2": LMLocationData("Balcony", 721, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=4, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 3": LMLocationData("Balcony", 722, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=5, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 4": LMLocationData("Balcony", 723, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=6, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 5": LMLocationData("Balcony", 724, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E08, bit_position=7, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 6": LMLocationData("Balcony", 725, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=0, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 7": LMLocationData("Balcony", 726, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=1, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 8": LMLocationData("Balcony", 727, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=2, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 9": LMLocationData("Balcony", 728, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=3, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 10": LMLocationData("Balcony", 729, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=4, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 11": LMLocationData("Balcony", 730, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=5, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 12": LMLocationData("Balcony", 731, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=6, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 13": LMLocationData("Balcony", 732, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E09, bit_position=7, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 14": LMLocationData("Balcony", 733, "Boolossus Boo", 0, VacnIce, remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E0A, bit_position=0, in_game_room_id=62)], map_id=[2,11]),
    "Boolossus Fragment 15": LMLocationData("Balcony", 734, "Boolossus Boo", 0, VacnIce, remote_only=True,
...
LIGHT_LOCATION_TABLE: dict[str, LMLocationData] = {
    "Butler's Room Light On": LMLocationData("Butler's Room", 743, "KingdomHearts", 0, Has("Shivers Spawn") & CanFstFire,
    ...
    "Fortune-Teller's Room Light On": LMLocationData("Fortune-Teller's Room", 745, "KingdomHearts", 0, HasMarioItems,
    ...
    "1F Hallway Light On": LMLocationData("1F Hallway", 773, "KingdomHearts", 0,
                                          CanReachLocation("Graveyard Clear Chest"), remote_only=True,
    ...
    "Dining Room Light On": LMLocationData("Dining Room", 749, "KingdomHearts", 0, CanFstFire,
    ...
    "2F Stairwell Light On": LMLocationData("2F Stairwell", 778, "KingdomHearts", 0,
                                            CanReachLocation("Balcony Clear Chest"),remote_only=True,
    ...
    "Twins' Room Light On": LMLocationData("Twins' Room", 741, "KingdomHearts", 0, HasKey(28), remote_only=True,
    ...
    "Sitting Room Light On": LMLocationData("Sitting Room", 757, "KingdomHearts", 0,
                                            CanFstFire & ((CanFstWater & OptionFilter(Enemizer, 2, "ne"))
                                                          |(True_() & OptionFilter(Enemizer, 2))),
        remote_only=True, update_ram_addr=[LMRamData(0x803CDF86, bit_position=1, in_game_room_id=28, ram_byte_size=2)]),
    "Guest Room Light On": LMLocationData("Guest Room", 758, "KingdomHearts", 0, CanFstWater,
        remote_only=True, update_ram_addr=[LMRamData(0x803CDF88, bit_position=1, in_game_room_id=29, ram_byte_size=2)]),
    "Family Hallway Light On": LMLocationData("Family Hallway", 772, "KingdomHearts", 0,
                                              CanReachLocation("Nursery Clear Chest"), remote_only=True,
        update_ram_addr=[LMRamData(0x803CDF8A, bit_position=1, in_game_room_id=30, ram_byte_size=2)]),
    "Attic Stairwell Light On": LMLocationData("2F Rear Hallway", 782, "KingdomHearts", 0,
                                               CanReachLocation("Balcony Clear Chest"), remote_only=True,
    ...
    "Parlor Light On": LMLocationData("Parlor", 735, "KingdomHearts", 0, HasKey(34)|HasKey(38), remote_only=True,
    ...
    "Astral Hall Light On": LMLocationData("Astral Hall", 765, "KingdomHearts", 0, CanFstFire,
    ...
    "2F Rear Hallway Light On": LMLocationData("2F Rear Hallway", 784, "KingdomHearts", 0,
                                               CanReachLocation("Balcony Clear Chest"), remote_only=True,
    ...
    "2F Bathroom Light On": LMLocationData("2F Bathroom", 786, "KingdomHearts", 0, CanFstIce,
    ...
    "East Attic Hallway Light On": LMLocationData("East Attic Hallway", 789, "KingdomHearts", 0,
                                                  CanReachLocation("Balcony Clear Chest"), remote_only=True,
    ...
    "West Attic Hallway Light On": LMLocationData("West Attic Hallway", 790, "KingdomHearts", 0,
                                                  CanReachLocation("Balcony Clear Chest"), remote_only=True,
    ...
    "Ceramics Studio Light On": LMLocationData("Ceramics Studio", 762, "KingdomHearts", 0, CanFstIce,
    ...
    "Balcony Light On": LMLocationData("Balcony", 770, "KingdomHearts", 0, VacnIce, remote_only=True,
    ...
    "Cold Storage Light On": LMLocationData("Cold Storage", 769, "KingdomHearts", 0, CanFstFire,
    ...
    "Basement Stairwell Light On": LMLocationData("Basement Stairwell", 851, "KingdomHearts", 0,
                                                  CanReachLocation("Balcony Clear Chest"), remote_only=True,
...
SILVER_PORTRAIT_TABLE: dict[str, LMLocationData] = {
    ...
    "Catch Henry and Orville - Silver": LMLocationData("Twins' Room", 978, "Portrait", 79, HasKey(28), remote_only=True,
    ...
    "Catch Shivers - Silver": LMLocationData("Butler's Room", 980, "Portrait", 29, Has("Shivers Spawn"),
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa85, bit_position=3)]),
    "Catch Clairvoya - Silver": LMLocationData("Fortune-Teller's Room", 981, "Portrait", 31, HasMarioItems,
    ...
    "Catch Mr. Luggs - Silver": LMLocationData("Dining Room", 983, "Portrait", 27, CanFstFire,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa85, bit_position=7)]),
    "Catch Spooky - Silver": LMLocationData("Boneyard", 984, "Portrait", 23, CanFstWater, remote_only=True,
    ...
    "Catch Miss Petunia - Silver": LMLocationData("2F Bathroom", 988, "Portrait", 83, CanFstIce,
    ...
    "Catch Sue Pea - Silver": LMLocationData("Guest Room", 990, "Portrait", 78, CanFstWater,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa88, bit_position=3)]),
    "Catch Grimmly - Silver": LMLocationData("Wardrobe", 991, "Portrait", 16, Has("Blackout"),
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa88, bit_position=7)]),
    "Catch Boolossus - Silver": LMLocationData("Balcony", 992, "Portrait", 56, VacnIce,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa87, bit_position=7)]),
    "Catch Jarvis - Silver": LMLocationData("Ceramics Studio", 993, "Portrait", 0, CanFstIce,
    ...
    "Catch Sir Weston - Silver": LMLocationData("Cold Storage", 996, "Portrait", 1, CanFstFire, remote_only=True,
...
GOLD_PORTRAIT_TABLE: dict[str, LMLocationData] = {
    ...
    "Catch Henry and Orville - Gold": LMLocationData("Twins' Room", 953, "Portrait", 79, HasKey(28), remote_only=True, all_true=True,
        update_ram_addr=[LMRamData(0x803cfa87, bit_position=5),
    ...
    "Catch Shivers - Gold": LMLocationData("Butler's Room", 955, "Portrait", 29, Has("Shivers Spawn"),
        remote_only=True,  all_true=True, update_ram_addr=[LMRamData(0x803cfa85, bit_position=3),
                                           LMRamData(0x803cfa85, bit_position=2)]),
    "Catch Clairvoya - Gold": LMLocationData("Fortune-Teller's Room", 956, "Portrait", 31, HasMarioItems,
    ...
    "Catch Mr. Luggs - Gold": LMLocationData("Dining Room", 958, "Portrait", 27, CanFstFire,
        remote_only=True, all_true=True, update_ram_addr=[LMRamData(0x803cfa85, bit_position=7),
                                           LMRamData(0x803cfa85, bit_position=6)]),
    "Catch Spooky - Gold": LMLocationData("Boneyard", 959, "Portrait", 23, CanFstWater, remote_only=True,
    ...
    "Catch Miss Petunia - Gold": LMLocationData("2F Bathroom", 963, "Portrait", 83, CanFstIce, all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa87, bit_position=1),
    ...
    "Catch Sue Pea - Gold": LMLocationData("Guest Room", 965, "Portrait", 78, CanFstWater, all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa88, bit_position=3),
                                           LMRamData(0x803cfa88, bit_position=3)]),
    "Catch Grimmly - Gold": LMLocationData("Wardrobe", 966, "Portrait", 16, Has("Blackout"), all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa88, bit_position=7),
                                           LMRamData(0x803cfa88, bit_position=6)]),
    "Catch Boolossus - Gold": LMLocationData("Balcony", 967, "Portrait", 56, VacnIce, all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa87, bit_position=7),
                                           LMRamData(0x803cfa87, bit_position=6)]),
    "Catch Jarvis - Gold": LMLocationData("Ceramics Studio", 968, "Portrait", 0, CanFstIce, all_true=True,
        remote_only=True, update_ram_addr=[LMRamData(0x803cfa88, bit_position=1),
    ...
    "Catch Sir Weston - Gold": LMLocationData("Cold Storage", 971, "Portrait", 1, CanFstFire, remote_only=True,
