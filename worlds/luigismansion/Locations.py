...
PLANT_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Balcony Plant Second from Right Plant near NW Bench": LMLocationData("Balcony", 873, "Plant", 615,
        ["Water Element Medal"], update_ram_addr=[LMRamData(in_game_room_id=62)]),
...
CEILING_LOCATION_TABLE ={
    ...
    "Attic Stairwell Ceiling Light": LMLocationData("2F Rear Hallway", 369, "Furniture", 547, [],
...
WALK_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "East Attic Hallway Visited": LMLocationData("East Attic Hallway", 846, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803CDFB6, bit_position=0, in_game_room_id=54, ram_byte_size=2),
                         LMRamData(0x803CDFC4, bit_position=0, in_game_room_id=61, ram_byte_size=2)]),
    ...
    "West Attic Hallway Visited": LMLocationData("West Attic Hallway", 847, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803CDFBC, bit_position=0, in_game_room_id=57, ram_byte_size=2),
                         LMRamData(0x803CDFB2, bit_position=0, in_game_room_id=52, ram_byte_size=2)]),
...
SILVER_PORTRAIT_TABLE: dict[str, LMLocationData] = {
    "Catch Neville - Silver": LMLocationData("Study", 877, "Portrait", 70, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=0, in_game_room_id=35)]),
    "Catch Lydia - Silver": LMLocationData("Master Bedroom", 878, "Portrait", 71, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=2, in_game_room_id=34)]),
    "Catch Chauncey - Silver": LMLocationData("Nursery", 879, "Portrait", 77, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=4, in_game_room_id=26)]),
    "Catch The Twins  - Silver": LMLocationData("Twins' Room", 880, "Portrait", 79, [], remote_only=True,
    ...
    "Catch Melody - Silver": LMLocationData("Conservatory", 883, "Portrait", 24, [],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E35, bit_position=4, in_game_room_id=22)]),
    "Catch Mr. Luggs - Silver": LMLocationData("Dining Room", 884, "Portrait", 27, ["Fire Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E35, bit_position=6, in_game_room_id=8)]),
    "Catch Spooky - Silver": LMLocationData("Boneyard", 885, "Portrait", 23, ["Water Element Medal"], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=0, in_game_room_id=11)]),
    "Catch Bogmire - Silver": LMLocationData("Graveyard", 886, "Portrait", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=2, in_game_room_id=15)]),
    "Catch Biff Atlas - Silver": LMLocationData("Rec Room", 887, "Portrait", 32, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=4, in_game_room_id=23)]),
    "Catch Slim Bankshot - Silver": LMLocationData("Billiards Room", 888, "Portrait", 26, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=6, in_game_room_id=12)]),
    "Catch Petunia - Silver": LMLocationData("2F Bathroom", 889, "Portrait", 83, ["Ice Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E37, bit_position=0, in_game_room_id=48)]),
    "Catch Nana - Silver": LMLocationData("Nana's Room", 890, "Portrait", 76, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E37, bit_position=2, in_game_room_id=49)]),
    "Catch Sue Pea - Silver": LMLocationData("Guest Room", 891, "Portrait", 78, ["Water Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=2, in_game_room_id=29)]),
    "Catch Grimmly - Silver": LMLocationData("Wardrobe", 892, "Portrait", 16, ["Blackout"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=6, in_game_room_id=41)]),
    "Catch Boolossus - Silver": LMLocationData("Balcony", 893, "Portrait", 56, ["Ice Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E37, bit_position=6, in_game_room_id=62)]),
    "Catch Jarvis - Silver": LMLocationData("Ceramics Studio", 894, "Portrait", 0, ["Ice Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=0, in_game_room_id=58)]),
    "Catch Clockwork Soldiers - Silver": LMLocationData("Clockwork Room", 895, "Portrait", 115, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E39, bit_position=0, in_game_room_id=59)]),
    "Catch Van Gore - Silver": LMLocationData("Artist's Studio", 896, "Portrait", 107, [],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=4, in_game_room_id=60)]),
    "Catch Sir Weston - Silver": LMLocationData("Cold Storage", 897, "Portrait", 1, ["Fire Element Medal"], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E39, bit_position=2, in_game_room_id=64)]),
}

GOLD_PORTRAIT_TABLE: dict[str, LMLocationData] = {
    "Catch Neville - Gold": LMLocationData("Study", 899, "Portrait", 70, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=1, in_game_room_id=35)]),
    "Catch Lydia - Gold": LMLocationData("Master Bedroom", 900, "Portrait", 71, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=3, in_game_room_id=34)]),
    "Catch Chauncey - Gold": LMLocationData("Nursery", 901, "Portrait", 77, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=5, in_game_room_id=26)]),
    "Catch The Twins - Gold": LMLocationData("Twins' Room", 902, "Portrait", 79, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E37, bit_position=5, in_game_room_id=27)]),
    "Catch The Whirlindas - Gold": LMLocationData("Ballroom", 903, "Portrait", 34, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E34, bit_position=7, in_game_room_id=9)]),
    "Catch Shivers - Gold": LMLocationData("Butler's Room", 904, "Portrait", 29, ["Fire Element Medal", "Shivers Spawn"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E35, bit_position=3, in_game_room_id=0)]),
    "Catch Clairvoya - Gold": LMLocationData("Fortune-Teller's Room", 905, "Portrait", 31, [],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E35, bit_position=1, in_game_room_id=3)]),
    "Catch Melody - Gold": LMLocationData("Conservatory", 906, "Portrait", 24, [],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E35, bit_position=5, in_game_room_id=22)]),
    "Catch Mr. Luggs - Gold": LMLocationData("Dining Room", 907, "Portrait", 27, ["Fire Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E35, bit_position=7, in_game_room_id=8)]),
    "Catch Spooky - Gold": LMLocationData("Boneyard", 908, "Portrait", 23, ["Water Element Medal"], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=1, in_game_room_id=11)]),
    "Catch Bogmire - Gold": LMLocationData("Graveyard", 909, "Portrait", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=3, in_game_room_id=15)]),
    "Catch Biff Atlas - Gold": LMLocationData("Rec Room", 910, "Portrait", 32, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=5, in_game_room_id=23)]),
    "Catch Slim Bankshot - Gold": LMLocationData("Billiards Room", 911, "Portrait", 26, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E36, bit_position=7, in_game_room_id=12)]),
    "Catch Petunia - Gold": LMLocationData("2F Bathroom", 912, "Portrait", 83, ["Ice Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E37, bit_position=1, in_game_room_id=48)]),
    "Catch Nana - Gold": LMLocationData("Nana's Room", 913, "Portrait", 76, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E37, bit_position=3, in_game_room_id=49)]),
    "Catch Sue Pea - Gold": LMLocationData("Guest Room", 914, "Portrait", 78, ["Water Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=3, in_game_room_id=29)]),
    "Catch Grimmly - Gold": LMLocationData("Wardrobe", 915, "Portrait", 16, ["Blackout"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=7, in_game_room_id=41)]),
    "Catch Boolossus - Gold": LMLocationData("Balcony", 916, "Portrait", 56, ["Ice Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E37, bit_position=7, in_game_room_id=62)]),
    "Catch Jarvis - Gold": LMLocationData("Ceramics Studio", 917, "Portrait", 0, ["Ice Element Medal"],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=1, in_game_room_id=58)]),
    "Catch Clockwork Soldiers - Gold": LMLocationData("Clockwork Room", 918, "Portrait", 115, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D5E39, bit_position=1, in_game_room_id=59)]),
    "Catch Van Gore - Gold": LMLocationData("Artist's Studio", 919, "Portrait", 107, [],
        remote_only=True, update_ram_addr=[LMRamData(0x803D5E38, bit_position=5, in_game_room_id=60)]),
    "Catch Sir Weston - Gold": LMLocationData("Cold Storage", 920, "Portrait", 1, ["Fire Element Medal"], remote_only=True,
