...
MEME_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Touch Courtyard Grass In front of Man Statue": LMLocationData("Courtyard", 882, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D33A8, bit_position=5, in_game_room_id=24, ram_byte_size=2)], require_poltergust=False),
    "Touch Courtyard Grass Left of Man Statue": LMLocationData("Courtyard", 883, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D33A8, bit_position=6, in_game_room_id=24, ram_byte_size=2)], require_poltergust=False),
    "Touch Courtyard Grass Behind Man Statue": LMLocationData("Courtyard", 884, "Walk", 0, [], remote_only=True,
    ...
    "Touch Courtyard Grass In front of Woman Statue": LMLocationData("Courtyard", 895, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D33AA, bit_position=2, in_game_room_id=24, ram_byte_size=2)], require_poltergust=False),
    "Touch Courtyard Grass Behind Woman Statue": LMLocationData("Courtyard", 896, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D33AA, bit_position=3, in_game_room_id=24, ram_byte_size=2)], require_poltergust=False),
    "Touch Courtyard Grass Left of Woman Statue": LMLocationData("Courtyard", 897, "Walk", 0, [], remote_only=True,
        update_ram_addr=[LMRamData(0x803D33AA, bit_position=4, in_game_room_id=24, ram_byte_size=2)], require_poltergust=False),
    "Touch Courtyard Grass Right of Woman Statue": LMLocationData("Courtyard", 898, "Walk", 0, [], remote_only=True,
