...
TREASURES_LOCATION_TABLE: dict[str, LMLocationData] = {
    ...
    "Dining Room R China Hutch": LMLocationData("Dining Room", 295, "Furniture", 279,
                                                update_ram_addr=[LMRamData(in_game_room_id=8)], require_poltergust=False),
    "Kitchen Oven": LMLocationData("Kitchen", 307, "Furniture", 80, CanFstFire,
                                   update_ram_addr=[LMRamData(in_game_room_id=7)]),
    ...
    "Pipe Room Bucket": LMLocationData("Pipe Room", 594, "Furniture", 22,
                                       update_ram_addr=[LMRamData(in_game_room_id=68)]),
    "Guest Room End Table": LMLocationData("Guest Room", 580, "Furniture", 497, CanFstWater,
                                           update_ram_addr=[LMRamData(in_game_room_id=29)]),
    "Secret Altar Brazier (near front, closest to 4th Wall)": LMLocationData("Secret Altar", 610, "Furniture", 28,
                                                                             update_ram_addr=[
    ...
    "Wardrobe Balcony Plant L (next to Toad)": LMLocationData("Wardrobe Balcony", 66, "Plant", 474,
                                                              CanFstWater,
                                                              update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Wardrobe Balcony Plant C": LMLocationData("Wardrobe Balcony", 67, "Plant", 475, CanFstWater,
                                               update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Wardrobe Balcony Plant L (in Corner)": LMLocationData("Wardrobe Balcony", 68, "Plant", 476,
                                                           CanFstWater,
                                                           update_ram_addr=[LMRamData(in_game_room_id=40)]),
    "Master Bedroom Plant": LMLocationData("Master Bedroom", 69, "Plant", 542, CanFstWater,
                                           update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard SW Plant": LMLocationData("Courtyard", 71, "Plant", 142, CanFstWater,
                                         update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard NW Plant": LMLocationData("Courtyard", 72, "Plant", 143, CanFstWater,
                                         update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Courtyard NE Plant": LMLocationData("Courtyard", 73, "Plant", 144, CanFstWater,
                                         update_ram_addr=[LMRamData(in_game_room_id=24)]),
    "Balcony Plant NW Not Near Bench": LMLocationData("Balcony", 75, "Plant", 604, CanFstWater,
                                                      update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant E Railing": LMLocationData("Balcony", 76, "Plant", 605, CanFstWater,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Near Bench": LMLocationData("Balcony", 77, "Plant", 606, CanFstWater,
                                                  update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant SW Corner": LMLocationData("Balcony", 81, "Plant", 610, CanFstWater,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant NW Corner": LMLocationData("Balcony", 82, "Plant", 611, CanFstWater,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony West Double Plant": LMLocationData("Balcony", 83, "Plant", 612, CanFstWater,
                                                update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Center R": LMLocationData("Balcony", 84, "Plant", 613, CanFstWater,
                                             update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Directly in NE Corner": LMLocationData("Balcony", 872, "Plant", 608, CanFstWater,
                                      update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant SE Corner": LMLocationData("Balcony", 80, "Plant", 609, CanFstWater,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Second from Right Plant near NW Bench": LMLocationData("Balcony", 873, "Plant", 615, CanFstWater,
                                       update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Furthest Right Plant near NW Bench": LMLocationData("Balcony", 874, "Plant", 614, CanFstWater,
                                       update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Second from Right in NE Corner": LMLocationData("Balcony", 875, "Plant", 616, CanFstWater,
                                       update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Center L": LMLocationData("Balcony", 88, "Plant", 712, CanFstWater,
                                             update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Balcony Plant Third from Right in NE Corner": LMLocationData("Balcony", 876, "Plant", 713, CanFstWater,
                                              update_ram_addr=[LMRamData(in_game_room_id=62)]),
    "Sitting Room Plant": LMLocationData("Sitting Room", 91, "Plant", 409, CanFstWater,
                                         update_ram_addr=[LMRamData(in_game_room_id=28)]),
    "Guest Room Plant": LMLocationData("Guest Room", 92, "Plant", 417, CanFstWater,
                                       update_ram_addr=[LMRamData(in_game_room_id=29)]),
}
