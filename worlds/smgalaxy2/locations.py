...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.TALL1COIN1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK1LOG),
    ...
    locname.CLOU1COIN1UP: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1CYMBAL),
