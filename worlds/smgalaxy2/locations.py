...
green_star_locations: dict[str, SMG2LocationData]  = {
    ...
    locname.SPACESTORMSTARG1:   SMG2LocationData(["Green Star Location", regname.SPACSTOR], regname.SPACSTOR,
                                                 regname.SPACSTOR1PULL, 1, (GreenStarRule)),
