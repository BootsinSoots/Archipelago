...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.PUZZLNOT1UP1: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.SHIP),
    locname.PUZZLNOT1UP2: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.SHIP),
    locname.PUZZLNOT1UP3: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.SHIP),
    locname.PUZZLCOIN1UP: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.SHIP),
    locname.PUZZLSAWB1UP: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.SHIP),
    locname.HIGH1PENG1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.SHIP),
    locname.HIGH1BON1UP1: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.SHIP),
    locname.HIGH1BON1UP2: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.SHIP),
    locname.HIGH1BON1UP3: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.SHIP),
    locname.HIGH1STAR1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.SHIP),
    locname.HIGH2PURP1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.SHIP),
    locname.BOUL1COME1UP: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.SHIP),
    locname.BOUL2STRT1UP: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.SHIP),
    locname.BOUL2BLU1UP1: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.SHIP),
    locname.BOUL2BLU1UP2: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.SHIP),
    locname.BOUL2BLU1UP3: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.SHIP),
    locname.COSM1JELL1UP: SMG2LocationData(["1-up Location"], regname.COSMICO, regname.SHIP),
    locname.COSM2MINE1UP: SMG2LocationData(["1-up Location"], regname.COSMICO, regname.SHIP),
    locname.COSM2FINA1UP: SMG2LocationData(["1-up Location"], regname.COSMICO, regname.SHIP),
    locname.WILDGLIDE1UP: SMG2LocationData(["1-up Location"], regname.WILDGLIDE, regname.SHIP),
    locname.HONEYCOIN1UP: SMG2LocationData(["1-up Location"], regname.HONEYBLOOM, regname.SHIP),
    locname.LAVA1MOVE1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.SHIP),
    locname.LAVA1FLOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.SHIP),
    locname.LAVA1COIN1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.SHIP),
    locname.LAVA1MATR1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.SHIP),
    locname.LAVA2WHOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.SHIP),
    locname.LAVA2STAR1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.SHIP),
