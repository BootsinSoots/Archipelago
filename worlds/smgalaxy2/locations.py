...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.RCOSTRIGT1UP: SMG2LocationData(["1-up Location"], regname.ROLLCOAST, regname.SHIP),
    locname.TWST1PLAK1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.TWST1GEAR1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.TWST2STRT1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.TWST2CHEK1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.TWST2OEND1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.TWST2FIN1UP1: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.TWST2FIN1UP2: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.SHIP),
    locname.STON1SPIN1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.SHIP),
    locname.STON1SHRK1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.SHIP),
    locname.STON2SLID1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.SHIP),
    locname.STON2TOYB1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.SHIP),
    locname.FLIP1STRT1UP: SMG2LocationData(["1-up Location"], regname.FLIPOUT, regname.SHIP),
