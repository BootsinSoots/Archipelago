...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.FLUF3BEH1UP2: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF3TOWER,
                                           RB.CanMakeCloud),
    locname.FLIPFENCE1UP: SMG2LocationData(["1-up Location"], regname.FLIPSWAP, regname.SHIP),
    locname.FLIPCHOMP1UP: SMG2LocationData(["1-up Location"], regname.FLIPSWAP, regname.SHIP),
    locname.FLIPPURPL1UP: SMG2LocationData(["1-up Location"], regname.FLIPSWAP, regname.SHIP),
    locname.RIGHTBON1UP1: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTBON1UP2: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTBON1UP3: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTELEV1UP: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTFIN1UP1: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTFIN1UP2: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTFIN1UP3: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTFIN1UP4: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTSTAR1UP: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.RIGHTCRAT1UP: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.SHIP),
    locname.FIERYWALL1UP: SMG2LocationData(["1-up Location"], regname.BOWJR1, regname.SHIP),
