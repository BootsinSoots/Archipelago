...
launch_star_locs: dict[str, SMG2LocationData] = {
    ...
    locname.CLOUCOUR1HLLS: SMG2LocationData(["Launch Stars"], regname.CLOUCOUR, regname.CLOUCOUR1TOWERS,
                                             CanReachEntrance(locname.CLOUCOUR1HLLS, parent_region_name=regname.CLOUCOUR1TOWERS)),
