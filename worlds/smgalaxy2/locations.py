...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.SHIPCLOUD1UP: SMG2LocationData(["1-up Location"], regname.SHIP2, regname.SHIP2,
                                           RB.CanMakeCloud),
    locname.SKST1PIOR1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1YELL1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1NOT1UP1: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1NOT1UP2: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1NOT1UP3: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1BON1UP1: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1BON1UP2: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1BON1UP3: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1CART1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1CRYS1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST1STAI1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2CHES1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2CHEK1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2BON1UP1: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2BON1UP2: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2BON1UP3: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2WOOD1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    locname.SKST2FLIP1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SHIP),
    ...
    locname.THROWBON1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
    locname.THROWBON1UP2: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
    locname.THROWBON1UP3: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
