...
checkpoint_loc_table: dict[str, SMG2LocationData] = {
    locname.SKYOBS1GREENHILLCP: SMG2LocationData(["Checkpoint Location", regname.SKYOBS],
                                                 regname.SKYOBS, regname.SKYOBS1GREENHILL),
    locname.SKYOBS1CYLINDERCP: SMG2LocationData(["Checkpoint Location", regname.SKYOBS],
                                                regname.SKYOBS, regname.SKYOBS1CYLINDER),
    locname.SKYOBS1BEFOREBOSSCP: SMG2LocationData(["Checkpoint Location", regname.SKYOBS],
                                                  regname.SKYOBS, regname.SKYOBS1BEFOREBOSS),
    locname.SKYOBS2SKYFLEETCP: SMG2LocationData(["Checkpoint Location", regname.SKYOBS],
                                                regname.SKYOBS, regname.SKYOBS2SKYFLEET),
    locname.SKYOBS2FLIPSWITCHCP: SMG2LocationData(["Checkpoint Location", regname.SKYOBS],
                                                  regname.SKYOBS, regname.SKYOBS2FLIPSWITCH),
    locname.SKYOBS2GRASSFLEETCP: SMG2LocationData(["Checkpoint Location", regname.SKYOBS],
                                                  regname.SKYOBS, regname.SKYOBS2GRASSFLEET),
    locname.GOODEGG1EARTHCP: SMG2LocationData(["Checkpoint Location", regname.GOODEGG],
                                              regname.GOODEGG, regname.GOODEGG1EARTH),
    locname.GOODEGG1FOSSILCP: SMG2LocationData(["Checkpoint Location", regname.GOODEGG],
                                               regname.GOODEGG, regname.GOODEGG1FOSSIL),
    locname.GOODEGG2SHOOTINGCP: SMG2LocationData(["Checkpoint Location", regname.GOODEGG],
                                                 regname.GOODEGG, regname.GOODEGG2SHOOTING),
    locname.GOODEGG2BOSSCP: SMG2LocationData(["Checkpoint Location", regname.GOODEGG],
                                             regname.GOODEGG, regname.GOODEGG2BOSS),
