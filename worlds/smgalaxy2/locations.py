...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.THROWNOT1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
    locname.THROWNOT1UP2: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
    locname.THROWNOT1UP3: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
    locname.THROWTHWO1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
    locname.THROWFLAG1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.SHIP),
