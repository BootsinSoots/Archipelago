...
launch_star_locs: dict[str, SMG2LocationData] = {
    ...
    locname.GOODEGG1PLALS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG1MUDDY, RB.CanLaunchStar),
    locname.GOODEGG1EARLS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG1EARTH, RB.CanLaunchStar),
    locname.GOODEGG1TOWLS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG1TOWER, RB.CanLaunchStar),
    locname.GOODEGG2PLALS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG2MUDDY, RB.CanLaunchStar),
    locname.GOODEGG2MIDLS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG2MUDDY, RB.CanLaunchStar),
    locname.GOODEGG2PLTLS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG2ORBITS, RB.CanLaunchStar),
    locname.GOODEGG2SHOLS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG2SHOOTING, RB.CanLaunchStar),
    locname.GOODEGG2MARLS: SMG2LocationData(["Launch Stars"], regname.GOODEGG, regname.GOODEGG2MARBLE, RB.CanLaunchStar),

    locname.SPINDIG1DIGLS: SMG2LocationData(["Launch Stars"], regname.SPINDIG, regname.SPINDIG1TETRA, RB.CanLaunchStar),
    locname.SPINDIG1DRILS: SMG2LocationData(["Launch Stars"], regname.SPINDIG, regname.SPINDIG1DRILL, RB.CanLaunchStar),
    locname.SPINDIG1STELS: SMG2LocationData(["Launch Stars"], regname.SPINDIG, regname.SPINDIG1STEEL, RB.CanLaunchStar),
    locname.SPINDIG1DIRLS: SMG2LocationData(["Launch Stars"], regname.SPINDIG, regname.SPINDIG1DIRTT, RB.CanLaunchStar),
    ...
    locname.FLUFFBLUFF1WALLS: SMG2LocationData(["Launch Stars"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1CLIFF2, RB.CanLaunchStar),
    locname.FLUFFBLUFF1WATLS: SMG2LocationData(["Launch Stars"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1WATER, RB.CanLaunchStar),
    locname.FLUFFBLUFF1LANSS: SMG2LocationData(["Launch Stars"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1LANDING, RB.CanLaunchStar),
    ...
    locname.PUZZPLAN1WIGLS: SMG2LocationData(["Launch Stars"], regname.PUZZPLAN, regname.PUZZPLAN1GROUND, RB.CanLaunchStar),
    locname.PUZZPLAN1GRALS: SMG2LocationData(["Launch Stars"], regname.PUZZPLAN, regname.PUZZPLAN1GRUZZY, RB.CanLaunchStar),
    locname.PUZZPLAN1CHELS: SMG2LocationData(["Launch Stars"], regname.PUZZPLAN, regname.PUZZPLAN1CHECKP, RB.CanLaunchStar),
    locname.PUZZPLAN1SAWSS: SMG2LocationData(["Launch Stars"], regname.PUZZPLAN, regname.PUZZPLAN1SAWBLA, RB.CanLaunchStar),
    ...
    locname.BOULBOWL1BOUSS: SMG2LocationData(["Launch Stars"], regname.BOULBOWL, regname.BOULBOWL1BOULDER, RB.CanLaunchStar),

    locname.HIGHTAIL1LANLS: SMG2LocationData(["Launch Stars"], regname.HIGHTAIL, regname.HIGHTAIL1LANDING, RB.CanLaunchStar),
    locname.HIGHTAIL1CLILS: SMG2LocationData(["Launch Stars"], regname.HIGHTAIL, regname.HIGHTAIL1GIANTRA, RB.CanLaunchStar),
    locname.HIGHTAIL1DASLS: SMG2LocationData(["Launch Stars"], regname.HIGHTAIL, regname.HIGHTAIL1PLATDAS, RB.CanLaunchStar),
    locname.HIGHTAIL2LANLS: SMG2LocationData(["Launch Stars"], regname.HIGHTAIL, regname.HIGHTAIL2LANDING, RB.CanLaunchStar),
    locname.HIGHTAIL2CLILS: SMG2LocationData(["Launch Stars"], regname.HIGHTAIL, regname.HIGHTAIL2GIANTRA, RB.CanLaunchStar),
    locname.HIGHTAIL2DASLS: SMG2LocationData(["Launch Stars"], regname.HIGHTAIL, regname.HIGHTAIL2PLATDAS, RB.CanLaunchStar),

    locname.COSMIC2LANLS: SMG2LocationData(["Launch Stars"], regname.COSMICO, regname.COSMIC2LANDING, RB.CanLaunchStar),
    ...
    locname.TALLTRUNK2BIGLS: SMG2LocationData(["Launch Stars"], regname.TALLTRUNK, regname.TALLTRUNK2BIGTREE, RB.CanLaunchStar),

    locname.CLOUCOUR1CYMLS: SMG2LocationData(["Launch Stars"], regname.CLOUCOUR, regname.CLOUCOUR1CYMBAL, RB.CanLaunchStar),
    locname.CLOUCOUR1TOWLS: SMG2LocationData(["Launch Stars"], regname.CLOUCOUR, regname.CLOUCOUR1TOWERS, RB.CanLaunchStar),
    locname.CLOUCOUR2LAULS: SMG2LocationData(["Launch Stars"], regname.CLOUCOUR, regname.CLOUCOUR2LANDING, RB.CanLaunchStar),
    locname.CLOUCOUR2CS1SS: SMG2LocationData(["Launch Stars"], regname.CLOUCOUR, regname.CLOUCOUR2CASTLE1, RB.CanLaunchStar),
    locname.CLOUCOUR2CS2SS: SMG2LocationData(["Launch Stars"], regname.CLOUCOUR, regname.CLOUCOUR2CASTLE2, RB.CanLaunchStar),
    ...
    locname.FREEFLAK1CABLS: SMG2LocationData(["Launch Stars"], regname.FREEFLAKE, regname.FREEFLAK1LOGCABI, RB.CanLaunchStar),
    locname.FREEFLAK2CABLS: SMG2LocationData(["Launch Stars"], regname.FREEFLAKE, regname.FREEFLAK2LOGCABI, RB.CanLaunchStar),
    locname.FREEFLAK2SNOLS: SMG2LocationData(["Launch Stars"], regname.FREEFLAKE, regname.FREEFLAK2SNOWBYH, RB.CanLaunchStar),
    ...
    locname.FEARFLET1AIRLS: SMG2LocationData(["Launch Stars"], regname.BOWJR2, regname.FEARFLET1AIRSHIP, RB.CanLaunchStar),
    locname.FEARFLET1FIRSS: SMG2LocationData(["Launch Stars"], regname.BOWJR2, regname.FEARFLET1UNDERGR, RB.CanLaunchStar),

    locname.SUPMASS1THWLS: SMG2LocationData(["Launch Stars"], regname.SUPMASS, regname.SUPMASS1THWOMPS, RB.CanLaunchStar),
    locname.SUPMASS1KOOLS: SMG2LocationData(["Launch Stars"], regname.SUPMASS, regname.SUPMASS1KOOPAS, RB.CanLaunchStar),
    locname.SUPMASS1BLOLS: SMG2LocationData(["Launch Stars"], regname.SUPMASS, regname.SUPMASS1STARCHIPS, RB.CanLaunchStar),
    ...
    locname.SWEETMYS1FLILS: SMG2LocationData(["Launch Stars"], regname.SWEETMYS, regname.SWEETMYS1SWITCHES, RB.CanLaunchStar),
    ...
    locname.FLIPVILL1LIFLS: SMG2LocationData(["Launch Stars"], regname.FLIPVILL, regname.FLIPVILL1LIFTTOP, RB.CanLaunchStar),
    locname.FLIPVILL1STALS: SMG2LocationData(["Launch Stars"], regname.FLIPVILL, regname.FLIPVILL1STARSHROOM, RB.CanLaunchStar),
    locname.FLIPVILL2DOLLS: SMG2LocationData(["Launch Stars"], regname.FLIPVILL, regname.FLIPVILL2MAZETOP, RB.CanLaunchStar),
    ...
    locname.STARBEACH1WATLS: SMG2LocationData(["Launch Stars"], regname.STARBEACH, regname.STARBEACH1WATER, RB.CanLaunchStar),
    locname.STARBEACH2WATLS: SMG2LocationData(["Launch Stars"], regname.STARBEACH, regname.STARBEACH2WATER, RB.CanLaunchStar),

    locname.CHOMWORK1STALS: SMG2LocationData(["Launch Stars"], regname.CHOMWORK, regname.CHOMWORK1START, RB.CanLaunchStar),
    locname.CHOMWORK1ROLLS: SMG2LocationData(["Launch Stars"], regname.CHOMWORK, regname.CHOMWORK1ROLLING, RB.CanLaunchStar),
    locname.CHOMWORK1FLILS: SMG2LocationData(["Launch Stars"], regname.CHOMWORK, regname.CHOMWORK1FLIPSWAP, RB.CanLaunchStar),
    locname.CHOMWORK2STALS: SMG2LocationData(["Launch Stars"], regname.CHOMWORK, regname.CHOMWORK2START, RB.CanLaunchStar),
    locname.CHOMWORK2ROLLS: SMG2LocationData(["Launch Stars"], regname.CHOMWORK, regname.CHOMWORK2ROLLING, RB.CanLaunchStar),
