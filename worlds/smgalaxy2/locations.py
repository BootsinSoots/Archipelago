...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.SPAC1TOPM1UP: SMG2LocationData(["1-up Location"], regname.SPACSTOR, regname.SHIP),
    locname.SPAC2BONU1UP: SMG2LocationData(["1-up Location"], regname.SPACSTOR, regname.SHIP),
    locname.SAND1BONU1UP: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SHIP),
    locname.SAND1TORC1UP: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SHIP),
    locname.SAND2TUB1UP1: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SHIP),
    locname.SAND2TUB1UP2: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SHIP),
    locname.SAND2TUB1UP3: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SHIP),
    locname.SAND2SSEA1UP: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SHIP),
    locname.SHIVEVOLC1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIP),
    locname.SHIVECHES1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIP),
    locname.SHIVESTON1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIP),
    locname.SHIVEMETE1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIP),
    locname.SHIVEICIC1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIP),
    locname.MOON1BON1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON1BON1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON1BON1UP3: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON1NOT1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON1NOT1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON1NOT1UP3: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON1BOOK1UP: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON2BON1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON2BON1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON2BON1UP3: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON2CRY1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON2CRY1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.MOON2WIND1UP: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.SHIP),
    locname.UPSIDPIPE1UP: SMG2LocationData(["1-up Location"], regname.UPDOWN, regname.SHIP),
    locname.FLEETWALL1UP: SMG2LocationData(["1-up Location"], regname.FLEETGLIDE, regname.SHIP),
    locname.FLEETGATE1UP: SMG2LocationData(["1-up Location"], regname.FLEETGLIDE, regname.SHIP),
    locname.BOOM1BULL1UP: SMG2LocationData(["1-up Location"], regname.BOWJR3, regname.SHIP),
    locname.BOOM1PLAT1UP: SMG2LocationData(["1-up Location"], regname.BOWJR3, regname.SHIP),
    locname.BOOM2BULL1UP: SMG2LocationData(["1-up Location"], regname.BOWJR3, regname.SHIP),
    locname.BOOM2BOSS1UP: SMG2LocationData(["1-up Location"], regname.BOWJR3, regname.SHIP),
    ...
    locname.CLOC1BONU1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK1COINROOM,
                                           RB.JumpHeight2),
