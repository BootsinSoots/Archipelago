...
CLOCKRUIN_loc: dict[str, SMG2LocationData] = {
    locname.CLOCKRUINSTAR1: SMG2LocationData(["Power Star Location", regname.CLOCKWORK], regname.CLOCKWORK,
                                             regname.CLOCKWORK1WHEELST, RB.CanPound & RB.CanWallJump
                                                                        & RB.CanSwing & RB.CanAirSpin),
...
green_star_locations: dict[str, SMG2LocationData]  = {
    ...
    locname.THROWBACKSTARG2:    SMG2LocationData(["Green Star Location", regname.WHOMPFORT], regname.WHOMPFORT,
                                                 regname.WHOMP1FORT, RB.JumpHeight4 | RB.CanWallSpin
                                                 | (RB.MediumLogic & RB.CanAirSpin) | RB.HellLogic),
...
oneup_locations: dict[str, SMG2LocationData] = {
    ...
    locname.SHIPTENFR1UP: SMG2LocationData(["1-up Location"], regname.SHIP2, regname.SHIP2,
                                           RB.CanDinoSwing),
    ...
    locname.SKST1NOT1UP1: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1GREENHILL),
    locname.SKST1NOT1UP2: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1GREENHILL),
    locname.SKST1NOT1UP3: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1GREENHILL),
    locname.SKST1BON1UP1: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1OCTOBONUS),
    locname.SKST1BON1UP2: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1OCTOBONUS),
    locname.SKST1BON1UP3: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1OCTOBONUS),
    locname.SKST1CART1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1CYLINDER),
    locname.SKST1CRYS1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1CYLINDER),
    locname.SKST1STAI1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS1BEFOREBOSS),
    locname.SKST2CHES1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS2STARTBOTTOM),
    locname.SKST2CHEK1UP: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS2SKYFLEET),
    locname.SKST2BON1UP1: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS2OCTOBONUS),
    locname.SKST2BON1UP2: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS2OCTOBONUS),
    locname.SKST2BON1UP3: SMG2LocationData(["1-up Location"], regname.SKYOBS, regname.SKYOBS2OCTOBONUS),
    ...
    locname.YOSH1FRUI1UP: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG1MUDDY),
    ...
    locname.YOSH1WOOD1UP: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG1FOSSIL),
    locname.YOSH2BON1UP1: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2MUDDY),
    locname.YOSH2BON1UP2: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2MUDDY),
    locname.YOSH2BON1UP3: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2MUDDY),
    locname.YOSH2CAGE1UP: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2MUDDY),
    locname.YOSH2SECR1UP: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2ORBITS),
    locname.YOSH2WOOD1UP: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2MARBLE),
    locname.YOSH2STON1UP: SMG2LocationData(["1-up Location"], regname.GOODEGG, regname.GOODEGG2MARBLE,
                                           RB.JumpHeight5),
    locname.SPIN1CAGE1UP: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG1TETRA,
                                           RB.DRILLMASTER),
    locname.SPIN1BON1UP1: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG1BONUS),
    locname.SPIN1BON1UP2: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG1BONUS),
    locname.SPIN1BON1UP3: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG1BONUS),
    locname.SPIN1YELL1UP: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG1STEEL),
    locname.SPIN2BON1UP1: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG2BONUS),
    locname.SPIN2BON1UP2: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG2BONUS),
    locname.SPIN2BON1UP3: SMG2LocationData(["1-up Location"], regname.SPINDIG, regname.SPINDIG2BONUS),
    locname.FLUF1BRID1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1LANDING),
    locname.FLUF1ROOC1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1COINROOM),
    locname.FLUF1CLOC1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1BIGCLOUD),
    locname.FLUF1BOMP1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1CLOUDCLIMB),
    locname.FLUF2BRID1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF2LANDING),
    locname.FLUF1CLOU1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF1TREECLIMB,
                                           RB.CanLongJump & RB.CanMakeCloud),
    locname.FLUF2TREE1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF2TREE),
    locname.FLUF2CLIF1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF2CLIFF),
    locname.FLUF3PLAT1UP: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF3TOWER,
                                           RB.CanMakeCloud),
    locname.FLUF3BEH1UP1: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF3TOWER,
                                           RB.CanMakeCloud),
    locname.FLUF3BEH1UP2: SMG2LocationData(["1-up Location"], regname.FLUFFBLUFF, regname.FLUFFBLUFF3TOWER,
                                           RB.CanMakeCloud),
    locname.FLIPFENCE1UP: SMG2LocationData(["1-up Location"], regname.FLIPSWAP, regname.FLIPSWAP1),
    locname.FLIPCHOMP1UP: SMG2LocationData(["1-up Location"], regname.FLIPSWAP, regname.FLIPSWAP1),
    locname.FLIPPURPL1UP: SMG2LocationData(["1-up Location"], regname.FLIPSWAP, regname.FLIPSWAP2),
    locname.RIGHTBON1UP1: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNBONUS),
    locname.RIGHTBON1UP2: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNBONUS),
    locname.RIGHTBON1UP3: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNBONUS),
    locname.RIGHTELEV1UP: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNCORRIDOR),
    locname.RIGHTFIN1UP1: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNTOPVIEW,
                                           RB.JumpHeight3),
    locname.RIGHTFIN1UP2: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNTOPVIEW,
                                           RB.JumpHeight3),
    locname.RIGHTFIN1UP3: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNTOPVIEW,
                                           RB.JumpHeight3),
    locname.RIGHTFIN1UP4: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNTOPVIEW,
                                           RB.JumpHeight3),
    locname.RIGHTSTAR1UP: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNTOPVIEW),
    locname.RIGHTCRAT1UP: SMG2LocationData(["1-up Location"], regname.RIGHTDOWN, regname.RIGHTDOWNCOINROOM,
                                           RB.FireMario|RB.CanPound),
    locname.FIERYWALL1UP: SMG2LocationData(["1-up Location"], regname.BOWJR1, regname.FIREFLOT1LANDING,
                                           RB.CanAirSpin | RB.CanBackflip
                                           | (RB.MediumLogic & RB.CanSideflip & RB.CanGrabLedge)
                                           | (RB.HardLogic & RB.CanTriple)),
    locname.PUZZLNOT1UP1: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.PUZZPLAN1GROUND,
                                           RB.CanPound),
    locname.PUZZLNOT1UP2: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.PUZZPLAN1GROUND,
                                           RB.CanPound),
    locname.PUZZLNOT1UP3: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.PUZZPLAN1GROUND,
                                           RB.CanPound),
    locname.PUZZLSAWB1UP: SMG2LocationData(["1-up Location"], regname.PUZZPLAN, regname.PUZZPLAN1SAWBLA),
    locname.HIGH1PENG1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL1GIANTRA),
    locname.HIGH1BON1UP1: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL1BONUS),
    locname.HIGH1BON1UP2: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL1BONUS),
    locname.HIGH1BON1UP3: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL1BONUS),
    locname.HIGH1STAR1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL1DASHWAL2),
    locname.HIGH2PENG1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL2GIANTRA),
    locname.HIGH2PURP1UP: SMG2LocationData(["1-up Location"], regname.HIGHTAIL, regname.HIGHTAIL2DASHWAL1),
    locname.BOUL1COME1UP: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.BOULBOWL1CRYSTAL,
                                           RB.ROCKNROLLIN | RB.MediumLogic),
    locname.BOUL2STRT1UP: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.BOULBOWL2ASTEROI),
    locname.BOUL2BLU1UP1: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.BOULBOWL2CAGEPLA,
                                           RB.ROCKNROLLIN | RB.HardLogic),
    locname.BOUL2BLU1UP2: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.BOULBOWL2CAGEPLA,
                                           RB.ROCKNROLLIN | RB.HardLogic),
    locname.BOUL2BLU1UP3: SMG2LocationData(["1-up Location"], regname.BOULBOWL, regname.BOULBOWL2CAGEPLA,
                                           RB.ROCKNROLLIN | RB.HardLogic),
    locname.COSM1JELL1UP: SMG2LocationData(["1-up Location"], regname.COSMICO, regname.COSMIC1POOL),
    locname.COSM2MINE1UP: SMG2LocationData(["1-up Location"], regname.COSMICO, regname.COSMIC2WATERPA),
    locname.COSM2FINA1UP: SMG2LocationData(["1-up Location"], regname.COSMICO, regname.COSMIC2WATERPL1,
                                           RB.DRILLMASTER),
    locname.WILDGLIDE1UP: SMG2LocationData(["1-up Location"], regname.WILDGLIDE, regname.WILDGLIDE1COURSE),
    locname.WILDGLIDE21UP: SMG2LocationData(["1-up Location"], regname.WILDGLIDE, regname.WILDGLIDE2COURSE),
    locname.LAVA1MOVE1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR1LAVACYL2),
    locname.LAVA1FLOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR1LAVAPLA1B),
    locname.LAVA1MATR1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR1LAVAPLA2C),
    locname.LAVA2MOVE1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR2LAVACYL2),
    locname.LAVA2FLOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR2LAVAPLA1B),
    locname.LAVA2WHOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR2LAVAPLA1W,
                                           RB.JumpHeight4 | RB.CanWallSpin
                                           | (RB.MediumLogic & RB.CanAirSpin) | RB.HellLogic),
    locname.LAVA2MATR1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR2LAVAPLA2C),
    locname.LAVA2STAR1UP: SMG2LocationData(["1-up Location"], regname.BOWSER1, regname.LAVALAIR2LAVAPLA2S),
    locname.TALL1CRYS1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK1BIGTREE),
    locname.TALL1BON1UP1: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK1PIRANHABONUS),
    locname.TALL1BON1UP2: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK1PIRANHABONUS),
    locname.TALL1BON1UP3: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK1PIRANHABONUS),
    locname.TALL1CHEK1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK1LOG),
    locname.TALL2CRYS1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2BIGTREE),
    locname.TALL2BON1UP1: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2PIRANHABONUS),
    locname.TALL2BON1UP2: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2PIRANHABONUS),
    locname.TALL2BON1UP3: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2PIRANHABONUS),
    locname.TALL2SPIK1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2SLIDE,
                                           RB.CanSlide),
    locname.TALL2GAPP1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2SLIDE,
                                           RB.CanAirSpin & RB.CanSlide),
    locname.TALL2STAR1UP: SMG2LocationData(["1-up Location"], regname.TALLTRUNK, regname.TALLTRUNK2SLIDEND),
    locname.CLOU1DINO1UP: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1LANDING),
    locname.CLOU1BON1UP1: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1PARAGOOMBONUS),
    locname.CLOU1BON1UP2: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1PARAGOOMBONUS),
    locname.CLOU1BON1UP3: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1PARAGOOMBONUS),
    locname.CLOU1DOME1UP: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1TOWERS),
    locname.CLOU1LEF1UP1: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1CASTLE),
    locname.CLOU1LEF1UP2: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1CASTLE),
    locname.CLOU1LEF1UP3: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1CASTLE),
    locname.CLOU1UPDR1UP: SMG2LocationData(["1-up Location"], regname.CLOUCOUR, regname.CLOUCOUR1CASTLE),
    locname.HAUN1BON1UP1: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL1JACKBON,
                                           RB.CanPound|RB.HardLogic),
    locname.HAUN1BON1UP2: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL1JACKBON,
                                           RB.CanPound|RB.HardLogic),
    locname.HAUN1BON1UP3: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL1JACKBON,
                                           RB.CanPound|RB.HardLogic),
    locname.HAUN1CARP1UP: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL1DISAPPE),
    locname.HAUN1BULB1UP: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL1BULBBER,
                                           RB.CanDinoGlow | RB.CanInfiniteFlutter),
    locname.HAUN2BON1UP1: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL2JACKBON,
                                           RB.CanPound|RB.HardLogic),
    locname.HAUN2BON1UP2: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL2JACKBON,
                                           RB.CanPound|RB.HardLogic),
    locname.HAUN2BON1UP3: SMG2LocationData(["1-up Location"], regname.HAUNHALL, regname.HAUNHALL2JACKBON,
                                           RB.CanPound|RB.HardLogic),
    locname.FREZ1HILL1UP: SMG2LocationData(["1-up Location"], regname.FREEFLAKE, regname.FREEFLAK1SNOWBYH),
    locname.FREZ1TREE1UP: SMG2LocationData(["1-up Location"], regname.FREEFLAKE, regname.FREEFLAK1SNOWBYH),
    locname.FREZ2HILL1UP: SMG2LocationData(["1-up Location"], regname.FREEFLAKE, regname.FREEFLAK1SNOWBYH),
    locname.FREZ2STR1UP1: SMG2LocationData(["1-up Location"], regname.FREEFLAKE, regname.FREEFLAK2WHITOUT),
    locname.FREZ2STR1UP2: SMG2LocationData(["1-up Location"], regname.FREEFLAKE, regname.FREEFLAK2WHITOUT),
    locname.FREZ2STR1UP3: SMG2LocationData(["1-up Location"], regname.FREEFLAKE, regname.FREEFLAK2WHITOUT),
    locname.RMAS1BRUS1UP: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST1PAINTBR),
    locname.RMAS1JUNK1UP: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST1ELEVATO),
    locname.RMAS1NOT1UP1: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST1SAWBLAD),
    locname.RMAS1NOT1UP2: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST1SAWBLAD),
    locname.RMAS1NOT1UP3: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST1SAWBLAD),
    locname.RMAS2BRUS1UP: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST2PAINTBR),
    locname.RMAS2JUNK1UP: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST2ELEVATO),
    locname.RMAS2GRS1UP1: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST2BOMBOMB),
    locname.RMAS2GRS1UP2: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST2BOMBOMB),
    locname.RMAS2GRS1UP3: SMG2LocationData(["1-up Location"], regname.ROLLMAST, regname.ROLLMAST2BOMBOMB),
    locname.BEAT1PATH1UP: SMG2LocationData(["1-up Location"], regname.BEATBLOCK, regname.BEATBLOK1),
    locname.BEAT1CRYS1UP: SMG2LocationData(["1-up Location"], regname.BEATBLOCK, regname.BEATBLOK1),
    locname.BEAT2PATH1UP: SMG2LocationData(["1-up Location"], regname.BEATBLOCK, regname.BEATBLOK2),
    locname.BEAT2PYRA1UP: SMG2LocationData(["1-up Location"], regname.BEATBLOCK, regname.BEATBLOK2),
    locname.FEAR1ELEC1UP: SMG2LocationData(["1-up Location"], regname.BOWJR2, regname.FEARFLET1BULLETB),
    locname.SUPE1LONG1UP: SMG2LocationData(["1-up Location"], regname.SUPMASS, regname.SUPMASS1PIPES,
                                           RB.CanLongJump | RB.CanAirSpin | RB.MediumLogic),
    locname.SUPE1THWO1UP: SMG2LocationData(["1-up Location"], regname.SUPMASS, regname.SUPMASS1THWOMPS,
                                           RB.CanWallJump),
    locname.SUPE1WIGG1UP: SMG2LocationData(["1-up Location"], regname.SUPMASS, regname.SUPMASS1WIGGLERS,
                                           RB.CanLongJump | RB.CanWallSpin | RB.MediumLogic),
    locname.SUPE2LONG1UP: SMG2LocationData(["1-up Location"], regname.SUPMASS, regname.SUPMASS2PIPES,
                                           RB.CanLongJump | RB.CanAirSpin | RB.MediumLogic),
    locname.SUPE2THWO1UP: SMG2LocationData(["1-up Location"], regname.SUPMASS, regname.SUPMASS2THWOMPS,
                                           RB.CanWallJump),
    locname.SUPE2WIGG1UP: SMG2LocationData(["1-up Location"], regname.SUPMASS, regname.SUPMASS2WIGGLERS,
                                           RB.CanLongJump | RB.CanWallSpin | RB.MediumLogic),
    locname.FLIP1BON1UP1: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL1TWIRLIP),
    locname.FLIP1BON1UP2: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL1TWIRLIP),
    locname.FLIP1BON1UP3: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL1TWIRLIP),
    locname.FLIP1CRAT1UP: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL1MAZEBACK,
                                           CanReachRegion(regname.FLIPVILL1MAZETOP) | (RB.CanAirSpin & RB.MediumLogic)),
    locname.FLIP2BON1UP1: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL2TWIRLIP),
    locname.FLIP2BON1UP2: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL2TWIRLIP),
    locname.FLIP2BON1UP3: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL2TWIRLIP),
    locname.FLIP2LAUN1UP: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL2MAZEBOTTOM),
    locname.FLIP2STAR1UP: SMG2LocationData(["1-up Location"], regname.FLIPVILL, regname.FLIPVILL2GRAVITYMAIN),
    locname.STSH1ROOF1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH1MAIN,
                                           RB.CanRideDino),
    locname.STSH1BON1UP1: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH1BONUS,
                                           RB.CanRideDino | RB.HellLogic),
    locname.STSH1BON1UP2: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH1BONUS,
                                           RB.CanRideDino | RB.HellLogic),
    locname.STSH1BON1UP3: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH1BONUS,
                                           RB.CanRideDino | RB.HellLogic),
    locname.STSH1BLIM1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH1MAIN,
                                           RB.CanDinoBlimp | RB.CanInfiniteFlutter),
    locname.STSH1OCEA1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH1MAIN,
                                           RB.CanSwim),
    locname.STSH2ROOF1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2MAIN,
                                           CanReachRegion(regname.STARBEACH2DEEPW) & RB.CanPound & RB.CanMakeCloud),
    locname.STSH2CHUK1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2MAIN),
    locname.STSH2SPRI1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2MAIN,
                                           CanReachRegion(regname.STARBEACH2DEEPW) & RB.CanPound & RB.CanMakeCloud),
    locname.STSH2GRIN1UP: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2DEEPW),
    #I'm still a little worried about these, especially if enemies will respawn when leaving - it's both difficult and luck-based
    locname.STSH2BON1UP1: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2BONUS),
    locname.STSH2BON1UP2: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2BONUS),
    locname.STSH2BON1UP3: SMG2LocationData(["1-up Location"], regname.STARBEACH, regname.STARBEACH2BONUS),
    locname.CHOM1CHBL1UP: SMG2LocationData(["1-up Location"], regname.CHOMWORK, regname.CHOMWORK1START),
    locname.CHOM1CHUP1UP: SMG2LocationData(["1-up Location"], regname.CHOMWORK, regname.CHOMWORK1ROLLING),
    locname.CHOM1TILT1UP: SMG2LocationData(["1-up Location"], regname.CHOMWORK, regname.CHOMWORK1FLIPSWAP),
    locname.CHOM2CHBL1UP: SMG2LocationData(["1-up Location"], regname.CHOMWORK, regname.CHOMWORK2START),
    locname.CHOM2CHEK1UP: SMG2LocationData(["1-up Location"], regname.CHOMWORK, regname.CHOMWORK2ROLLING),
    locname.CHOM2SPIN1UP: SMG2LocationData(["1-up Location"], regname.CHOMWORK, regname.CHOMWORK2TOWER,
                                           RB.SPRONGIN | (RB.HardLogic & RB.CanWallSpin & RB.CanBackOrSideflip)),
    ...
    locname.GRAVICHEK1UP: SMG2LocationData(["1-up Location"], regname.BOWSER2, regname.GRAVGAUN1WHOMPWA,
                                           (RB.CanWallSpin & (RB.CanSideflip | RB.CanTriple | (RB.HardLogic & RB.CanLongSpin)))
                                           | (RB.CanAirSpin & RB.CanBackflip)),
    locname.GRAVIWHOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER2, regname.GRAVGAUN1WHOMPWA),
    locname.GRAVIGATE1UP: SMG2LocationData(["1-up Location"], regname.BOWSER2, regname.GRAVGAUN1WHOMPWA),
    locname.GRAVI2WATR1UP: SMG2LocationData(["1-up Location"], regname.BOWSER2, regname.GRAVGAUN2WATERCO),
    locname.GRAVI2CHEK1UP: SMG2LocationData(["1-up Location"], regname.BOWSER2, regname.GRAVGAUN2WHOMPWA,
                                           (RB.CanWallSpin & (RB.CanSideflip | RB.CanTriple | (RB.HardLogic & RB.CanLongSpin)))
                                           | (RB.CanAirSpin & RB.CanBackflip)),
    locname.GRAVI2WHOM1UP: SMG2LocationData(["1-up Location"], regname.BOWSER2, regname.GRAVGAUN2WHOMPWA),
    locname.SPAC1BACK1UP: SMG2LocationData(["1-up Location"], regname.SPACSTOR, regname.SPACSTOR1PULL),
    locname.SPAC1TOPM1UP: SMG2LocationData(["1-up Location"], regname.SPACSTOR, regname.SPACSTOR1TOPMAN),
    locname.SPAC2BACK1UP: SMG2LocationData(["1-up Location"], regname.SPACSTOR, regname.SPACSTOR2PULL),
    locname.SAND1TORC1UP: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SLIPSAND1CUBE),
    locname.SAND2TUB1UP1: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SLIPSAND2LONG3,
                                           RB.CanAirSpin),
    locname.SAND2TUB1UP2: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SLIPSAND2LONG3,
                                           RB.CanAirSpin),
    locname.SAND2TUB1UP3: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SLIPSAND2LONG3,
                                           RB.CanAirSpin),
    locname.SAND2SSEA1UP: SMG2LocationData(["1-up Location"], regname.SLIPSAND, regname.SLIPSAND2BIRD),
    locname.SHIVEVOLC1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIVBURN1VOLCANO,
                                           RB.HardLogic | (RB.CanPound & RB.CanMakeCloud)
                                           | (RB.MediumLogic & RB.CanLongJump & (RB.CloudMario | RB.CanAirSpin))),
    locname.SHIVECHES1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIVBURN1LAVA),
    locname.SHIVESTON1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIVBURN1LAVA),
    locname.SHIVEMETE1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIVBURN1FIREICE),
    locname.SHIVEICIC1UP: SMG2LocationData(["1-up Location"], regname.SHIVBURN, regname.SHIVBURN1FIREICE),
    locname.MOON1BON1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1GOOMBONUS,
                                           RB.CanPound | RB.HardLogic),
    locname.MOON1BON1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1GOOMBONUS,
                                           RB.CanPound | RB.HardLogic),
    locname.MOON1BON1UP3: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1GOOMBONUS,
                                           RB.CanPound | RB.HardLogic),
    locname.MOON1NOT1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1POISON),
    locname.MOON1NOT1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1POISON),
    locname.MOON1NOT1UP3: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1POISON),
    locname.MOON1BOOK1UP: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON1POPUP),
    locname.MOON2BON1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON2GOOMBONUS),
    locname.MOON2BON1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON2GOOMBONUS),
    locname.MOON2BON1UP3: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON2GOOMBONUS),
    locname.MOON2CRY1UP1: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON2DARK),
    locname.MOON2CRY1UP2: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON2DARK),
    locname.MOON2WIND1UP: SMG2LocationData(["1-up Location"], regname.BOOMOON, regname.BOOMOON2TOWER,
                                           RB.BooMario),
    locname.UPSIDPIPE1UP: SMG2LocationData(["1-up Location"], regname.UPDOWN, regname.UPDOWNINSTART),
    locname.FLEET1WALL1UP: SMG2LocationData(["1-up Location"], regname.FLEETGLIDE, regname.FLEETGLIDE1COURSE),
    locname.FLEET1GATE1UP: SMG2LocationData(["1-up Location"], regname.FLEETGLIDE, regname.FLEETGLIDE1COURSE),
    locname.FLEET2WALL1UP: SMG2LocationData(["1-up Location"], regname.FLEETGLIDE, regname.FLEETGLIDE1COURSE),
    locname.FLEET2GATE1UP: SMG2LocationData(["1-up Location"], regname.FLEETGLIDE, regname.FLEETGLIDE1COURSE),

    locname.BOOM2BOSS1UP: SMG2LocationData(["1-up Location"], regname.BOWJR3, regname.BOOMBUNK2DARK,
                                           RB.CanMakeCloud | (RB.CloudMario & ((RB.MediumLogic & RB.CanLongJump)
                                                                               | (RB.HardLogic & RB.CanBackflip)))),
    locname.MELT2BOWL1UP: SMG2LocationData(["1-up Location"], regname.MELTY, regname.MELTY2BOWLING,
                                           RB.ROCKNROLLIN),
    locname.CLOC1PUSH1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK1PUSH),
    locname.CLOC1DRAL1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK1WHEELSB),
    locname.CLOC1STON1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK1WHEELST),
    locname.CLOC1DRUM1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK1WHEELST),
    locname.CLOC3HAMM1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK3HAMMER),
    locname.CLOC3LEDG1UP: SMG2LocationData(["1-up Location"], regname.CLOCKWORK, regname.CLOCKWORK3HAMMERTOP,
                                           (RB.CanBackOrSideflip & RB.CanAirSpin) | RB.HellLogic
                                           | (RB.MediumLogic & (RB.CanBackOrSideflip | (RB.CanTriple & RB.CanAirSpin)))),
    locname.THROW1BON1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1BONUS),
    locname.THROW1BON1UP2: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1BONUS),
    locname.THROW1BON1UP3: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1BONUS),
    locname.THROW1NOT1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1FORT),
    locname.THROW1NOT1UP2: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1FORT),
    locname.THROW1NOT1UP3: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1FORT),
    locname.THROW1THWO1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1FORT,
                                            RB.JumpHeight3 | RB.CanGrabLedge | (RB.CanLongJump & RB.MediumLogic)),
    locname.THROW1FLAG1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP1FORT,
                                            RB.CanClimbPole),
    locname.THROW2NOT1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP2FORT),
    locname.THROW2NOT1UP2: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP2FORT),
    locname.THROW2NOT1UP3: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP2FORT),
    locname.THROW2THWO1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP2FORT,
                                            RB.JumpHeight3 | RB.CanGrabLedge | (RB.CanLongJump & RB.MediumLogic)),
    locname.THROW2FLAG1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP2FORT,
                                            RB.CanClimbPole | RB.CanMakeCloud),
    locname.THROW3NOT1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP3FORT),
    locname.THROW3NOT1UP2: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP3FORT),
    locname.THROW3NOT1UP3: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP3FORT),
    locname.THROW3THWO1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP3FORT,
                                            RB.JumpHeight3 | RB.CanGrabLedge | (RB.CanLongJump & RB.MediumLogic)),
    locname.THROW3FLAG1UP: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP3FORT,
                                            RB.CanClimbPole | RB.CanMakeCloud),
    locname.THROW2BON1UP1: SMG2LocationData(["1-up Location"], regname.WHOMPFORT, regname.WHOMP2BONUS),
    ...
    locname.SLIMYLCHE1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI1CHESTROOM,
                                           RB.CanShell),
    locname.SLIMYMCHE1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI1CHESTROOM,
                                           RB.CanShell),
    locname.SLIMYTCHE1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI1CHESTROOM,
                                           RB.CanShell),
    locname.SLIMYLAUN1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI1CAVE1,
                                           RB.CanSwim & (RB.CanShell | RB.HardLogic)),
    locname.SLIMYCHEK1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI1MOUTH2,
                                           RB.CanAirSpin | RB.CanLongJump | RB.MediumLogic),
    locname.SLIMY2TUN1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI2CAVE1),
    locname.SLIMY2LAU1UP: SMG2LocationData(["1-up Location"], regname.SLIMSPRI, regname.SLIMSPRI2CAVE1,
                                           RB.CanSwim & (RB.CanShell | RB.HardLogic)),
    locname.GALA1DRIL1UP: SMG2LocationData(["1-up Location"], regname.BOWSER3, regname.GALGEN1LAVACYL),
    locname.GALA1CLOU1UP: SMG2LocationData(["1-up Location"], regname.BOWSER3, regname.GALGEN1TOWER,
                                           RB.CanMakeCloud | (RB.CanWallSpin & (RB.CanLongJump | RB.HardLogic))
                                           | RB.CanLongSpin | (RB.CloudMario & RB.CanBackflip & RB.HardLogic)),
    locname.GALA1YOSH1UP: SMG2LocationData(["1-up Location"], regname.BOWSER3, regname.GALGEN1YOSHI,
                                           RB.CanDinoSwing | (RB.CanMakeCloud & RB.CanWallJump & RB.HardLogic)
                                           | RB.CanInfiniteFlutter),
    locname.GALA2CLOU1UP: SMG2LocationData(["1-up Location"], regname.BOWSER3, regname.GALGEN2TOWER,
                                           RB.CanMakeCloud | (RB.CanWallSpin & (RB.CanLongJump | RB.HardLogic))
                                           | RB.CanLongSpin | (RB.CloudMario & RB.CanBackflip & RB.HardLogic)),
    locname.GALA2YOSH1UP: SMG2LocationData(["1-up Location"], regname.BOWSER3, regname.GALGEN2YOSHI,
                                           RB.CanDinoSwing | (RB.CanMakeCloud & RB.CanWallJump & RB.HellLogic)
                                           | RB.CanInfiniteFlutter),
    locname.GALA2MEDA1UP: SMG2LocationData(["1-up Location"], regname.BOWSER3, regname.GALGEN2LAVASNA),
    locname.MARIOFLOT1UP: SMG2LocationData(["1-up Location"], regname.MARIO, regname.MARIOSQ1MAIN),
    locname.RCOSTLEFT1UP: SMG2LocationData(["1-up Location"], regname.ROLLCOAST, regname.ROLLCOAST1),
    locname.RCOSTRIGT1UP: SMG2LocationData(["1-up Location"], regname.ROLLCOAST, regname.ROLLCOAST1),
    locname.RCOST2RIGT1UP: SMG2LocationData(["1-up Location"], regname.ROLLCOAST, regname.ROLLCOAST1),
    locname.TWST1PLAK1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY1PLAT2),
    locname.TWST1GEAR1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY1PLAT3),
    locname.TWST2STRT1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY2PLAT1),
    locname.TWST2CHEK1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY2PLAT2),
    locname.TWST2GEAR1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY2PLAT3),
    locname.TWST2OEND1UP: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY2PLAT3),
    locname.TWST2FIN1UP1: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY2PLAT4),
    locname.TWST2FIN1UP2: SMG2LocationData(["1-up Location"], regname.TWISTTRI, regname.TWISTY2PLAT4),
    locname.STON1SPIN1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.STONECYC1,
                                           RB.CanPound | RB.MediumLogic),
    locname.STON1SHRK1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.STONECYC1,
                                           RB.CanPound | RB.MediumLogic),
    locname.STON2SLID1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.STONECYC2),
    locname.STON2TOYB1UP: SMG2LocationData(["1-up Location"], regname.STONECYC, regname.STONECYC2),
    locname.FLIP1STRT1UP: SMG2LocationData(["1-up Location"], regname.FLIPOUT, regname.FLIPOUT1LANDING,
                                           RB.CanWallSpin),
    locname.FLIP1FINA1UP: SMG2LocationData(["1-up Location"], regname.FLIPOUT, regname.FLIPOUT1CLIMB,
                                           RB.CanWallSpin),
    locname.FLIP2COME1UP: SMG2LocationData(["1-up Location"], regname.FLIPOUT, regname.FLIPOUT2CLIMB,
                                           RB.CanWallSpin & (RB.CanLongJump | RB.HardLogic)),
    locname.GRND1CLOU1UP: SMG2LocationData(["1-up Location"], regname.GRANDMASTER, regname.GRANDMASTER1CLOUD,
                                           RB.CanMakeCloud | (RB.CloudMario & RB.HardLogic)),
    locname.GRND2CLOU1UP: SMG2LocationData(["1-up Location"], regname.GRANDMASTER, regname.GRANDMASTER2CLOUD,
                                           RB.CanMakeCloud | (RB.CloudMario & RB.HardLogic)),
...
bonus_teleporter_locations: dict[str, SMG2LocationData] = {
    ...
    locname.HAUNTY1BONUSCL: SMG2LocationData(["Specials"], regname.HAUNHALL, regname.HAUNHALL1JACKBON,
                                             default_access=RB.CanPound|RB.HardLogic),
