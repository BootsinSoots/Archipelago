...
region_list: dict[str, SMG2RegionData] = {
    ...
    regname.FLIPVILL1MAZESTART:         SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1MAZEBOTTOM:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1MAZEBACK:          SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1COMETMEDAL:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1TWIRLIP:           SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1MAZETOP:           SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1WANWANSTART:       SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1WANWANALLEY:       SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1WANWANLANE:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1WANWANBACK:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1LIFTSTART:         SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1LIFTBELOW:         SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1LIFTTOP:           SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1STARSHROOM:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1GLAM:              SMG2RegionData("Planet", [], []),
    regname.FLIPVILL1STAR:              SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2MAZESTART:         SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2MAZEBOTTOM:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2MAZEBACK:          SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2TWIRLIP:           SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2MAZETOP:           SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2MAZELAUNCH:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2TOWERSTART:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2TOWERBELOW:        SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2PIPE:              SMG2RegionData("Planet", [], []),
    regname.FLIPVILL2GRAVITYSTART:      SMG2RegionData("Planet", [], []),
    ...
    regname.FLEETGLIDE1START:           SMG2RegionData("Planet", [], []),
    regname.FLEETGLIDE1COURSE:          SMG2RegionData("Planet", [], []),
    regname.FLEETGLIDE2START:           SMG2RegionData("Planet", [], []),
    regname.FLEETGLIDE2COURSE:          SMG2RegionData("Planet", [], []),
    ...
    regname.UPDOWNINSTART:              SMG2RegionData("Planet", [], []),
    regname.UPDOWNINEND:                SMG2RegionData("Planet", [], []),
    ...
    regname.FLIPOUT1LANDING:            SMG2RegionData("Planet", [], []),
    regname.FLIPOUT1CLIMB:              SMG2RegionData("Planet", [], []),
    regname.FLIPOUT2LANDING:            SMG2RegionData("Planet", [], []),
    regname.FLIPOUT2CLIMB:              SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN1BLOCK:             SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN1GROUND:            SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN1GRUZZY:            SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN3BUGABO:            SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN1COINRO:            SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN1SAWBLA:            SMG2RegionData("Planet", [], []),
    regname.PUZZPLAN1CHECKP:            SMG2RegionData("Planet", [], []),
    ...
    regname.FREEFLAK1LOGCABI:           SMG2RegionData("Planet", [], []),
    regname.FREEFLAK1SNOWBYH:           SMG2RegionData("Planet", [], []),
    regname.FREEFLAK3CHIMP:             SMG2RegionData("Planet", [], []),
    regname.FREEFLAK1SLIDELA:           SMG2RegionData("Planet", [], []),
    regname.FREEFLAK1LAVASNO:           SMG2RegionData("Planet", [], []),
    regname.FREEFLAK2LOGCABI:           SMG2RegionData("Planet", [], []),
    regname.FREEFLAK2SNOWBYH:           SMG2RegionData("Planet", [], []),
    regname.FREEFLAK2WHITOUT:           SMG2RegionData("Planet", [], []),
    ...
    regname.ROLLMAST1LANDING:           SMG2RegionData("Planet", [], []),
    regname.ROLLMAST1PAINTBR:           SMG2RegionData("Planet", [], []),
    regname.ROLLMAST1ELEVATO:           SMG2RegionData("Planet", [], []),
    regname.ROLLMAST1SAWBLAD:           SMG2RegionData("Planet", [], []),
    regname.ROLLMAST1SILVERC:           SMG2RegionData("Planet", [], []),
    regname.ROLLMAST2LANDING:           SMG2RegionData("Planet", [], []),
    regname.ROLLMAST2PAINTBR:           SMG2RegionData("Planet", [], []),
    ...
    regname.WILDGLIDE1START:            SMG2RegionData("Planet", [], []),
    regname.WILDGLIDE1COURSE:           SMG2RegionData("Planet", [], []),
    regname.WILDGLIDE2START:            SMG2RegionData("Planet", [], []),
    regname.WILDGLIDE2COURSE:           SMG2RegionData("Planet", [], []),
    regname.SUPMASS2START:              SMG2RegionData("Planet", [], []),
    regname.SUPMASS2PIPES:              SMG2RegionData("Planet", [], []),
    regname.SUPMASS2THWOMPS:            SMG2RegionData("Planet", [], []),
    regname.SUPMASS2KOOPAS:             SMG2RegionData("Planet", [], []),
    regname.SUPMASS2STARCHIPS:          SMG2RegionData("Planet", [], []),
    regname.SUPMASS2GARDEN:             SMG2RegionData("Planet", [], []),
    regname.SUPMASS2WIGGLERS:           SMG2RegionData("Planet", [], []),
    regname.STARBEACH1WATER:            SMG2RegionData("Planet", [], []),
    regname.STARBEACH1MAIN:             SMG2RegionData("Planet", [], []),
    regname.STARBEACH1BONUS:            SMG2RegionData("Planet", [], []),
    regname.STARBEACH1COINR:            SMG2RegionData("Planet", [], []),
    regname.STARBEACH2WATER:            SMG2RegionData("Planet", [], []),
    regname.STARBEACH2MAIN:             SMG2RegionData("Planet", [], []),
    regname.STARBEACH2BONUS:            SMG2RegionData("Planet", [], []),
    ...
    regname.SWEETMYS1START:             SMG2RegionData("Planet", [], []),
    regname.SWEETMYS1COOKIE:            SMG2RegionData("Planet", [], []),
    regname.SWEETMYS1CHOCO:             SMG2RegionData("Planet", [], []),
    regname.SWEETMYS1BISCUIT:           SMG2RegionData("Planet", [], []),
    regname.SWEETMYS1SWITCHES:          SMG2RegionData("Planet", [], []),
    regname.SWEETMYS2START:             SMG2RegionData("Planet", [], []),
    regname.SWEETMYS2COOKIE:            SMG2RegionData("Planet", [], []),
    regname.SWEETMYS2CHOCO:             SMG2RegionData("Planet", [], []),
    regname.SWEETMYS2BISCUIT:           SMG2RegionData("Planet", [], []),
    regname.SWEETMYS2END:               SMG2RegionData("Planet", [], []),
    regname.HONEYHOP1START:             SMG2RegionData("Planet", [], []),
    regname.HONEYHOP1POND:              SMG2RegionData("Planet", [], []),
    regname.HONEYHOP1CLOUDS:            SMG2RegionData("Planet", [], []),
    regname.HONEYHOP1QBBASE:            SMG2RegionData("Planet", [], []),
    regname.HONEYHOP1QBBUBBLE:          SMG2RegionData("Planet", [], []),
    regname.HONEYHOP1QBTOP:             SMG2RegionData("Planet", [], []),
    regname.HONEYHOP2QBBASE:            SMG2RegionData("Planet", [], []),
    regname.HONEYHOP2QBBUBBLE:          SMG2RegionData("Planet", [], []),
    regname.HONEYHOP2QBTOP:             SMG2RegionData("Planet", [], []),
